...
Charts in qyl are not merely visual garnish. In many screens they are part of the analysis workflow, so chart-library
choice is an architectural decision.
