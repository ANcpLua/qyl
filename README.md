...
The latest public qyl release is 7.1.0. The
...
| --- | --- | --- |
| `qyl` (dotnet tool) | 7.1.0 | this one |
...
| `Qyl.Api.Contracts`, `@ancplua/qyl-api-schema` | 11.2.0 | [qyl-api-schema](https://github.com/ANcpLua/qyl-api-schema) |
| `qyl-mcp-server` | 7.0.0 | [qyl.mcp](https://github.com/ANcpLua/qyl.mcp) |
| `Qyl.Api.Sdk` (MSBuild SDK) | 7.1.0 | this one |
