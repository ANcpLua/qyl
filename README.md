...
This auto-instruments `IChatClient` calls (Microsoft.Extensions.AI) with full OTel 1.40 GenAI semantic conventions — token usage, latency, model info, finish reasons.
