...
{
    /// <summary>
    /// Default ActivitySource name used by QYL when emitting its own spans.
    /// </summary>
    public const string DefaultSourceName = "qyl.Agents.AI";
    ...
    {
        /// <summary>
        /// Convenience: operation values we care about most.
        /// </summary>
        ...
        {
            /// <summary>
            /// gen_ai.provider.name – canonical provider id (openai, anthropic, gcp.gemini, etc.).
            /// </summary>
        ...
        {
            /// <summary>
            /// gen_ai.operation.name – chat/generate_content/text_completion/invoke_agent/execute_tool/…
            /// </summary>
        ...
        /// QYL001 will warn whenever any of these show up. :contentReference[oaicite:5]{index=5}
        /// </summary>
