...
/// <summary>
/// Emits TypeScript type definitions for the dashboard.
/// Generates:
...
internal static class TypeScriptEmitter
{
    ...
    public static string EmitModels(QylSchema schema)
    {
        ...
        foreach (var (key, attr) in schema.GenAiAttributes.Where(a => a.Value.IsDeprecated && a.Value.ReplacedBy is not null))
        {
    ...
    public static string EmitApiTypes(QylSchema schema)
    {
        var sb = new StringBuilder();
    ...
    public static string EmitIndex()
    {
        var sb = new StringBuilder();
    ...
    private static string MapPrimitiveToTypeScript(string csharpType)
    {
    ...
    private static string MapTypeToTypeScript(string csharpType)
    {
