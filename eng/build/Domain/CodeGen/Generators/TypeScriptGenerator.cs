...
{
    const string GeneratorName = nameof(TypeScriptGenerator);
    ...
    static string EmitModels(QylSchema schema)
    {
        ...
        sb.Append(GeneratedFileHeaders.TypeScript(GeneratorName, "models.ts"));
    ...
    static string EmitApiTypes(QylSchema schema)
    {
        ...
        sb.Append(GeneratedFileHeaders.TypeScript(GeneratorName, "api-types.ts"));
        ...
        sb.AppendLine("  /** Pagination offset */");
        ...
        sb.AppendLine("  to?: string;");
        sb.AppendLine("  /** Filter by minimum duration in milliseconds */");
        sb.AppendLine("  minDurationMs?: number;");
        sb.AppendLine("  /** Filter by status code (error only) */");
        sb.AppendLine("  hasError?: boolean;");
        sb.AppendLine("  /** Maximum results to return */");
        sb.AppendLine("  limit?: number;");
        sb.AppendLine("  /** Pagination offset */");
        sb.AppendLine("  offset?: number;");
        ...
        sb.AppendLine("// ═══════════════════════════════════════════════════════════════════════════════");
        sb.AppendLine("// API Response Types");
        sb.AppendLine("// ═══════════════════════════════════════════════════════════════════════════════");
        sb.AppendLine();

        // Paginated response
        sb.AppendLine("/** Paginated list response */");
        sb.AppendLine("export interface PaginatedResponse<T> {");
        sb.AppendLine("  /** List items */");
        sb.AppendLine("  items: T[];");
        sb.AppendLine("  /** Total count (if available) */");
        sb.AppendLine("  totalCount?: number;");
        sb.AppendLine("  /** Current offset */");
        sb.AppendLine("  offset: number;");
        sb.AppendLine("  /** Items per page */");
        sb.AppendLine("  limit: number;");
    ...
    static string EmitIndex()
    {
        ...
        sb.Append(GeneratedFileHeaders.TypeScript(GeneratorName, "index.ts"));
