// qyl.cli - CLI Tool
// Command-line interface for schema operations and config generation
...
internal static class Program
{
    public static async Task<int> Main(string[] args)
    {
        ...
        rootCommand.Add(CreateValidateCommand());
        rootCommand.Add(CreateUpdateSchemasCommand());
    ...
    {
        var command = new Command("generate", "Generate collector configuration from schema files");
        command.Add(CreateGenerateOttlCommand());
        return command;
    }
    ...
    private static async Task<int> GenerateOttlHandler(string targetVersion, FileInfo? output)
    {
        try
        {
            // v1.38 only - simplified generation
            var config = $"""
