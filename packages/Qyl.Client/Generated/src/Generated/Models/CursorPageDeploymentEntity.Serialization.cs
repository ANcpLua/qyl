...
namespace Qyl.Common.Pagination
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="CursorPageDeploymentEntity"/> for deserialization. </summary>
        ...
        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="CursorPageDeploymentEntity"/> from. </param>
