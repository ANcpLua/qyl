...
namespace Qyl.Common.Pagination
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="CursorPageWorkflowNodeEntity"/> for deserialization. </summary>
        ...
        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="CursorPageWorkflowNodeEntity"/> from. </param>
