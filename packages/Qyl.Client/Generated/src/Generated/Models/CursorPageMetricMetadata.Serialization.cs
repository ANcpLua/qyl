...
namespace ANcpLua.OtelConventions.Common.Pagination
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="CursorPageMetricMetadata"/> for deserialization. </summary>
        ...
        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="CursorPageMetricMetadata"/> from. </param>
