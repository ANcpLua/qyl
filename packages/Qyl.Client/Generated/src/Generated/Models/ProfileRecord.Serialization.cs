...
namespace Qyl.Storage
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="ProfileRecord"/> for deserialization. </summary>
        ...
        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="ProfileRecord"/> from. </param>
