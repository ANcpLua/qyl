...
namespace Qyl.Domains.Alerting
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="FixRunEntity"/> for deserialization. </summary>
        ...
        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="FixRunEntity"/> from. </param>
