...
namespace Qyl.Domains.Workflow
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="WorkflowRunEntity"/> for deserialization. </summary>
        ...
        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="WorkflowRunEntity"/> from. </param>
