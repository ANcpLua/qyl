...
namespace Qyl.Common.Pagination
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="CursorPageGenerationProfileEntity"/> for deserialization. </summary>
        ...
        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="CursorPageGenerationProfileEntity"/> from. </param>
