...
namespace Qyl.Common.Pagination
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="CursorPageAlertFiringEntity"/> for deserialization. </summary>
        ...
        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="CursorPageAlertFiringEntity"/> from. </param>
