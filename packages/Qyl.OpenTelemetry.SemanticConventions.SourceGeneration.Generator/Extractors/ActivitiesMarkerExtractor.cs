...
internal static class ActivitiesMarkerExtractor
{
    public static ActivitiesMarkerModel? Extract(
        ...
        CancellationToken cancellationToken)
    {
        ...
        return new ActivitiesMarkerModel(ns, typeSymbol.Name, prefix, filter);
    }
}
