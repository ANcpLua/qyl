...
export interface AlertsApiClientContext extends Client {

}

export interface AlertsApiClientOptions extends ClientOptions {
    endpoint?: string;
}

export function createAlertsApiClientContext(
    endpoint: "https://api.staging.qyl.dev" | "https://api.qyl.dev" | string,
    options?: AlertsApiClientOptions,
): AlertsApiClientContext {
