...
import {
    ...
    jsonAlertFiringAcknowledgementToTransportTransform,
    jsonAlertFiringEntityToApplicationTransform,
    jsonAlertRuleEntityToApplicationTransform,
    jsonAlertRuleEntityToTransportTransform,
    jsonCursorPageToApplicationTransform_16 as jsonCursorPageToApplicationTransform,
    jsonCursorPageToApplicationTransform_17 as jsonCursorPageToApplicationTransform_2,
    jsonCursorPageToApplicationTransform_18 as jsonCursorPageToApplicationTransform_3,
    jsonFixRunEntityToApplicationTransform
...
export function listRules(
    ...
    return buildPagedAsyncIterator<AlertRuleEntity, ListRulesPageResponse, ListRulesPageSettings>({
        getElements,
...
export function listFirings(
    ...
    return buildPagedAsyncIterator<AlertFiringEntity, ListFiringsPageResponse, ListFiringsPageSettings>({
        getElements,
        getPagedResponse: getPagedResponse as any
    });
}
...
export async function acknowledgeFiring(
    ...
    const httpRequestOptions = {
        headers: {}, body: jsonAlertFiringAcknowledgementToTransportTransform(acknowledgement),
    };
    const response = await client.pathUnchecked(path).post(httpRequestOptions);
...
export function listFixRuns(
    ...
    return buildPagedAsyncIterator<FixRunEntity, ListFixRunsPageResponse, ListFixRunsPageSettings>({
        getElements,
        getPagedResponse: getPagedResponse as any
    });
}
