...
import {
    ...
    jsonCursorPageToApplicationTransform_7 as jsonCursorPageToApplicationTransform,
    jsonDeploymentCreateToTransportTransform,
    jsonDeploymentEntityToApplicationTransform,
    jsonDeploymentUpdateToTransportTransform,
    jsonDoraMetricsToApplicationTransform
...
export function list(
    ...
    return buildPagedAsyncIterator<DeploymentEntity, ListPageResponse, ListPageSettings>({
        getElements,
