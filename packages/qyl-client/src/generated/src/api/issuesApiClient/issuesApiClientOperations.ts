...
import {
    ...
    jsonArrayErrorBreadcrumbEntityToApplicationTransform,
    jsonCursorPageToApplicationTransform_12 as jsonCursorPageToApplicationTransform,
    jsonCursorPageToApplicationTransform_13 as jsonCursorPageToApplicationTransform_2,
    jsonErrorIssueEntityToApplicationTransform,
    jsonIssueUpdateRequestToTransportTransform
} from "../../models/internal/serializers.js";
import {
    type ErrorBreadcrumbEntity,
    ErrorIssueEntity,
...
export function list(
    ...
    return buildPagedAsyncIterator<ErrorIssueEntity, ListPageResponse, ListPageSettings>({
        getElements,
...
export function getEvents(
    ...
    return buildPagedAsyncIterator<ErrorIssueEventEntity, GetEventsPageResponse, GetEventsPageSettings>({
        getElements,
        getPagedResponse: getPagedResponse as any
    });
}
