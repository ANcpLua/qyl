...
import { dateRfc3339Serializer, jsonArrayLogPatternToApplicationTransform, jsonCursorPageToApplicationTransform_3 as jsonCursorPageToApplicationTransform, jsonLogAggregationRequestToTransportTransform, jsonLogAggregationResponseToApplicationTransform, jsonLogQueryToTransportTransform, jsonLogStatsToApplicationTransform } from "../../models/internal/serializers.js";
import { LogAggregationRequest, type LogAggregationResponse, type LogOrderBy, type LogPattern, type LogQuery, LogRecord, type LogStats, type SeverityNumber } from "../../models/models.js";
...
export function list(
  ...
  return buildPagedAsyncIterator<LogRecord, ListPageResponse, ListPageSettings>({getElements, getPagedResponse: getPagedResponse as any});
}
...
export function search(
  ...
  return buildPagedAsyncIterator<LogRecord, SearchPageResponse, SearchPageSettings>({getElements, getPagedResponse: getPagedResponse as any});
}
