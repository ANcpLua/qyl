...
import { dateRfc3339Serializer, jsonCursorPageToApplicationTransform_5 as jsonCursorPageToApplicationTransform, jsonCursorPageToApplicationTransform as jsonCursorPageToApplicationTransform_2, jsonSessionEntityToApplicationTransform, jsonSessionStatsToApplicationTransform } from "../../models/internal/serializers.js";
...
export function list(
  ...
  return buildPagedAsyncIterator<SessionEntity, ListPageResponse, ListPageSettings>({getElements, getPagedResponse: getPagedResponse as any});
}
...
export function getTraces(
  ...
  return buildPagedAsyncIterator<Trace, GetTracesPageResponse, GetTracesPageSettings>({getElements, getPagedResponse: getPagedResponse as any});
}
