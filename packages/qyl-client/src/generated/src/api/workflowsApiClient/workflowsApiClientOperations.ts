...
import {
    ...
    jsonArrayWorkflowEventEntityToApplicationTransform,
    jsonCursorPageToApplicationTransform_14 as jsonCursorPageToApplicationTransform,
    jsonCursorPageToApplicationTransform_15 as jsonCursorPageToApplicationTransform_2,
    jsonWorkflowNodeEntityToApplicationTransform,
    jsonWorkflowRunEntityToApplicationTransform
} from "../../models/internal/serializers.js";
import {
    type WorkflowEventEntity,
    WorkflowNodeEntity,
    WorkflowRunEntity,
...
export function listRuns(
    ...
    return buildPagedAsyncIterator<WorkflowRunEntity, ListRunsPageResponse, ListRunsPageSettings>({
        getElements,
...
export function getRunNodes(
    ...
    return buildPagedAsyncIterator<WorkflowNodeEntity, GetRunNodesPageResponse, GetRunNodesPageSettings>({
        getElements,
        getPagedResponse: getPagedResponse as any
    });
}
