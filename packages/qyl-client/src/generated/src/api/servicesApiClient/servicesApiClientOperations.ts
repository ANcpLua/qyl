...
import {
    jsonArrayServiceDependencyToApplicationTransform,
    jsonCursorPageToApplicationTransform_8 as jsonCursorPageToApplicationTransform,
    jsonCursorPageToApplicationTransform_9 as jsonCursorPageToApplicationTransform_2,
    jsonServiceDetailsToApplicationTransform
...
export function list(
    ...
    return buildPagedAsyncIterator<ServiceInfo, ListPageResponse, ListPageSettings>({
        getElements,
...
export function getOperations(
    ...
    return buildPagedAsyncIterator<OperationInfo, GetOperationsPageResponse, GetOperationsPageSettings>({
        getElements,
        getPagedResponse: getPagedResponse as any
    });
}
