...
import { dateRfc3339Serializer, jsonCursorPageToApplicationTransform, jsonCursorPageToApplicationTransform_2, jsonTraceQueryToTransportTransform, jsonTraceToApplicationTransform } from "../../models/internal/serializers.js";
...
export function list(
  ...
  return buildPagedAsyncIterator<Trace, ListPageResponse, ListPageSettings>({getElements, getPagedResponse: getPagedResponse as any});
}
...
export function getSpans(
  ...
  return buildPagedAsyncIterator<SpanRecord, GetSpansPageResponse, GetSpansPageSettings>({getElements, getPagedResponse: getPagedResponse as any});
}
...
export function search(
  ...
  return buildPagedAsyncIterator<Trace, SearchPageResponse, SearchPageSettings>({getElements, getPagedResponse: getPagedResponse as any});
}
