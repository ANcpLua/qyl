...
export interface StreamingClientContext extends Client {

}export interface StreamingClientOptions extends ClientOptions {
  endpoint?: string;
}export function createStreamingClientContext(
