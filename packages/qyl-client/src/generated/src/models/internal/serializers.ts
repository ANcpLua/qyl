...
export function updatePayloadToTransport(payload: IssueUpdateRequest) {
    return jsonIssueUpdateRequestToTransportTransform(payload)!;
}

export function createProfilePayloadToTransport(
    payload: GenerationProfileCreateRequest,
) {
    return jsonGenerationProfileCreateRequestToTransportTransform(payload)!;
}
...
export function createJobPayloadToTransport(
    ...
    return jsonGenerationJobCreateRequestToTransportTransform(payload)!;
}
...
export function createProjectPayloadToTransport(
    payload: ProjectCreateRequest,
) {
    return jsonProjectCreateRequestToTransportTransform(payload)!;
}

export function createPayloadToTransport(payload: DeploymentCreate) {
    return jsonDeploymentCreateToTransportTransform(payload)!;
}

export function updatePayloadToTransport_2(payload: DeploymentUpdate) {
    return jsonDeploymentUpdateToTransportTransform(payload)!;
}

export function updatePayloadToTransport_3(payload: ErrorUpdate) {
    return jsonErrorUpdateToTransportTransform(payload)!;
}
...
export function jsonCursorPageToTransportTransform(
    ...
    return {
        items: jsonArrayTraceToTransportTransform(input_.items),
        next_cursor: input_.nextCursor,
        prev_cursor: input_.prevCursor,
        has_more: input_.hasMore
    }!;
}
...
export function jsonCursorPageToApplicationTransform(
    ...
    return {
        items: jsonArrayTraceToApplicationTransform(input_.items),
        nextCursor: input_.next_cursor,
        prevCursor: input_.prev_cursor,
        hasMore: input_.has_more
    }!;
}
...
export function jsonTraceToTransportTransform(input_?: Trace | null): any {
    ...
    return {
        trace_id: input_.traceId,
        spans: jsonArraySpanToTransportTransform(input_.spans),
        root_span: jsonSpanToTransportTransform(input_.rootSpan),
        span_count: input_.spanCount,
        duration_ns: input_.durationNs,
        start_time: dateRfc3339Serializer(input_.startTime),
        end_time: dateRfc3339Serializer(input_.endTime),
        services: jsonArrayStringToTransportTransform(input_.services),
        has_error: input_.hasError
    }!;
}
...
export function jsonTraceToApplicationTransform(input_?: any): Trace {
    ...
    return {
        ...
        spans: jsonArraySpanToApplicationTransform(input_.spans),
        rootSpan: jsonSpanToApplicationTransform(input_.root_span),
        spanCount: input_.span_count,
        durationNs: input_.duration_ns,
        startTime: dateDeserializer(input_.start_time)!,
        endTime: dateDeserializer(input_.end_time)!,
        services: jsonArrayStringToApplicationTransform(input_.services),
        hasError: input_.has_error
    }!;
}
...
export function jsonSpanToTransportTransform(input_?: Span | null): any {
    ...
    return {
        span_id: input_.spanId,
        trace_id: input_.traceId,
        parent_span_id: input_.parentSpanId,
        trace_state: input_.traceState,
        name: input_.name,
        kind: input_.kind,
        start_time_unix_nano: input_.startTimeUnixNano,
        end_time_unix_nano: input_.endTimeUnixNano,
        attributes: jsonArrayAttributeToTransportTransform(input_.attributes),
        dropped_attributes_count: input_.droppedAttributesCount,
        events: jsonArraySpanEventToTransportTransform(input_.events),
        dropped_events_count: input_.droppedEventsCount,
        links: jsonArraySpanLinkToTransportTransform(input_.links),
        dropped_links_count: input_.droppedLinksCount,
        status: jsonSpanStatusToTransportTransform(input_.status),
        flags: input_.flags,
        resource: jsonResourceToTransportTransform(input_.resource),
        instrumentation_scope: jsonInstrumentationScopeToTransportTransform(input_.instrumentationScope)
    }!;
}
...
export function jsonSpanToApplicationTransform(input_?: any): Span {
    ...
    return {
        spanId: input_.span_id,
        traceId: input_.trace_id,
        parentSpanId: input_.parent_span_id,
        traceState: input_.trace_state,
        name: input_.name,
        kind: input_.kind,
        startTimeUnixNano: input_.start_time_unix_nano,
        endTimeUnixNano: input_.end_time_unix_nano,
        attributes: jsonArrayAttributeToApplicationTransform(input_.attributes),
        droppedAttributesCount: input_.dropped_attributes_count,
        events: jsonArraySpanEventToApplicationTransform(input_.events),
        droppedEventsCount: input_.dropped_events_count,
        links: jsonArraySpanLinkToApplicationTransform(input_.links),
        droppedLinksCount: input_.dropped_links_count,
        status: jsonSpanStatusToApplicationTransform(input_.status),
        flags: input_.flags,
        resource: jsonResourceToApplicationTransform(input_.resource),
        instrumentationScope: jsonInstrumentationScopeToApplicationTransform(input_.instrumentation_scope)
    }!;
}
...
export function jsonSpanEventToTransportTransform(
    ...
    return {
        name: input_.name,
        time_unix_nano: input_.timeUnixNano,
        attributes: jsonArrayAttributeToTransportTransform(input_.attributes),
        dropped_attributes_count: input_.droppedAttributesCount
    }!;
}
...
export function jsonSpanEventToApplicationTransform(input_?: any): SpanEvent {
    ...
    return {
        name: input_.name,
        timeUnixNano: input_.time_unix_nano,
        attributes: jsonArrayAttributeToApplicationTransform(input_.attributes),
        droppedAttributesCount: input_.dropped_attributes_count
    }!;
}
...
export function jsonResourceToTransportTransform(
    ...
    return {
        "service.name": input_.serviceName,
        "service.namespace": input_.serviceNamespace,
        "service.instance.id": input_.serviceInstanceId,
        "service.version": input_.serviceVersion,
        "telemetry.sdk.name": input_.telemetrySdkName,
        "telemetry.sdk.language": input_.telemetrySdkLanguage,
        "telemetry.sdk.version": input_.telemetrySdkVersion,
        "telemetry.auto.version": input_.telemetryAutoVersion,
        "deployment.environment.name": input_.deploymentEnvironment,
        "cloud.provider": input_.cloudProvider,
        "cloud.region": input_.cloudRegion,
        "cloud.availability_zone": input_.cloudAvailabilityZone,
        "cloud.account.id": input_.cloudAccountId,
        "cloud.platform": input_.cloudPlatform,
        "host.name": input_.hostName,
        "host.id": input_.hostId,
        "host.type": input_.hostType,
        "host.arch": input_.hostArch,
        "os.type": input_.osType,
        "os.description": input_.osDescription,
        "os.version": input_.osVersion,
        "process.pid": input_.processPid,
        "process.executable.name": input_.processExecutableName,
        "process.command_line": input_.processCommandLine,
        "process.runtime.name": input_.processRuntimeName,
        "process.runtime.version": input_.processRuntimeVersion,
        "container.id": input_.containerId,
        "container.name": input_.containerName,
        "container.image.name": input_.containerImageName,
        "container.image.tag": input_.containerImageTag,
        "k8s.cluster.name": input_.k8sClusterName,
        "k8s.namespace.name": input_.k8sNamespaceName,
        "k8s.pod.name": input_.k8sPodName,
        "k8s.pod.uid": input_.k8sPodUid,
        "k8s.deployment.name": input_.k8sDeploymentName,
        attributes: jsonArrayAttributeToTransportTransform(input_.attributes),
        dropped_attributes_count: input_.droppedAttributesCount
    }!;
}
...
export function jsonResourceToApplicationTransform(input_?: any): Resource {
    ...
    return {
        ...
        serviceNamespace: input_.service.namespace,
        serviceInstanceId: input_.service.instance.id,
        serviceVersion: input_.service.version,
        telemetrySdkName: input_.telemetry.sdk.name,
        telemetrySdkLanguage: input_.telemetry.sdk.language,
        telemetrySdkVersion: input_.telemetry.sdk.version,
        telemetryAutoVersion: input_.telemetry.auto.version,
        deploymentEnvironment: input_.deployment.environment.name,
        cloudProvider: input_.cloud.provider,
        cloudRegion: input_.cloud.region,
        cloudAvailabilityZone: input_.cloud.availability_zone,
        cloudAccountId: input_.cloud.account.id,
        cloudPlatform: input_.cloud.platform,
        hostName: input_.host.name,
        hostId: input_.host.id,
        hostType: input_.host.type,
        hostArch: input_.host.arch,
        osType: input_.os.type,
        osDescription: input_.os.description,
        osVersion: input_.os.version,
        processPid: input_.process.pid,
        processExecutableName: input_.process.executable.name,
        processCommandLine: input_.process.command_line,
        processRuntimeName: input_.process.runtime.name,
        processRuntimeVersion: input_.process.runtime.version,
        containerId: input_.container.id,
        containerName: input_.container.name,
        containerImageName: input_.container.image.name,
        containerImageTag: input_.container.image.tag,
        k8sClusterName: input_.k8s.cluster.name,
        k8sNamespaceName: input_.k8s.namespace.name,
        k8sPodName: input_.k8s.pod.name,
        k8sPodUid: input_.k8s.pod.uid,
        k8sDeploymentName: input_.k8s.deployment.name,
        attributes: jsonArrayAttributeToApplicationTransform(input_.attributes),
        droppedAttributesCount: input_.dropped_attributes_count
    }!;
}
...
export function jsonInstrumentationScopeToTransportTransform(
    ...
    return {
        name: input_.scopeName,
        version: input_.scopeVersion,
        attributes: jsonArrayAttributeToTransportTransform(input_.scopeAttributes),
        dropped_attributes_count: input_.droppedAttributesCount
    }!;
}
...
export function jsonInstrumentationScopeToApplicationTransform(
    ...
    return {
        scopeName: input_.name,
        scopeVersion: input_.version,
        scopeAttributes: jsonArrayAttributeToApplicationTransform(input_.attributes),
        droppedAttributesCount: input_.dropped_attributes_count
    }!;
}
...
export function jsonCursorPageToTransportTransform_2(
    ...
    return {
        items: jsonArraySpanRecordToTransportTransform(input_.items),
        next_cursor: input_.nextCursor,
        prev_cursor: input_.prevCursor,
        has_more: input_.hasMore
    }!;
...
export function jsonCursorPageToApplicationTransform_2(
    ...
    return {
        items: jsonArraySpanRecordToApplicationTransform(input_.items),
        nextCursor: input_.next_cursor,
        prevCursor: input_.prev_cursor,
        hasMore: input_.has_more
    }!;
...
export function jsonSpanRecordToTransportTransform(
    ...
    return {
        spanId: input_.spanId,
        traceId: input_.traceId,
        parentSpanId: input_.parentSpanId,
        sessionId: input_.sessionId,
        name: input_.name,
        kind: input_.kind,
        startTimeUnixNano: input_.startTimeUnixNano,
        endTimeUnixNano: input_.endTimeUnixNano,
        durationNs: input_.durationNs,
        statusCode: input_.statusCode,
        statusMessage: input_.statusMessage,
        serviceName: input_.serviceName,
        genAiProviderName: input_.genAiProviderName,
        genAiRequestModel: input_.genAiRequestModel,
        genAiResponseModel: input_.genAiResponseModel,
        genAiInputTokens: input_.genAiInputTokens,
        genAiOutputTokens: input_.genAiOutputTokens,
        genAiTemperature: input_.genAiTemperature,
        genAiStopReason: input_.genAiStopReason,
        genAiToolName: input_.genAiToolName,
        genAiToolCallId: input_.genAiToolCallId,
        genAiCostUsd: input_.genAiCostUsd,
        attributesJson: input_.attributesJson,
        resourceJson: input_.resourceJson,
        baggageJson: input_.baggageJson,
        schemaUrl: input_.schemaUrl,
...
export function jsonTraceQueryToTransportTransform(
    ...
    return {
        query: input_.query,
        service_name: input_.serviceName,
        operation_name: input_.operationName,
        min_duration_ms: input_.minDurationMs,
        max_duration_ms: input_.maxDurationMs,
        status: input_.status,
        start_time: dateRfc3339Serializer(input_.startTime),
        end_time: dateRfc3339Serializer(input_.endTime),
        tags: jsonRecordStringToTransportTransform(input_.tags),
        limit: input_.limit,
        cursor: input_.cursor
    }!;
}
...
export function jsonTraceQueryToApplicationTransform(
    ...
    return {
        query: input_.query,
        serviceName: input_.service_name,
        operationName: input_.operation_name,
        minDurationMs: input_.min_duration_ms,
        maxDurationMs: input_.max_duration_ms,
        status: input_.status,
        startTime: dateDeserializer(input_.start_time)!,
        endTime: dateDeserializer(input_.end_time)!,
        tags: jsonRecordStringToApplicationTransform(input_.tags),
        limit: input_.limit,
        cursor: input_.cursor
    }!;
}
...
export function jsonCursorPageToTransportTransform_3(
    ...
    return {
        items: jsonArrayLogRecordToTransportTransform(input_.items),
        next_cursor: input_.nextCursor,
        prev_cursor: input_.prevCursor,
        has_more: input_.hasMore
    }!;
...
export function jsonCursorPageToApplicationTransform_3(
    ...
    return {
        items: jsonArrayLogRecordToApplicationTransform(input_.items),
        nextCursor: input_.next_cursor,
        prevCursor: input_.prev_cursor,
        hasMore: input_.has_more
    }!;
...
export function jsonLogRecordToTransportTransform(
    ...
    return {
        time_unix_nano: input_.timeUnixNano,
        observed_time_unix_nano: input_.observedTimeUnixNano,
        severity_number: input_.severityNumber,
        severity_text: input_.severityText,
        body: jsonLogBodyToTransportTransform(input_.body),
        attributes: jsonArrayAttributeToTransportTransform(input_.attributes),
        dropped_attributes_count: input_.droppedAttributesCount,
        flags: input_.flags,
        trace_id: input_.traceId,
...
export function jsonLogRecordToApplicationTransform(input_?: any): LogRecord {
    ...
    return {
        timeUnixNano: input_.time_unix_nano,
        observedTimeUnixNano: input_.observed_time_unix_nano,
        severityNumber: input_.severity_number,
        severityText: input_.severity_text,
        body: jsonLogBodyToApplicationTransform(input_.body),
        attributes: jsonArrayAttributeToApplicationTransform(input_.attributes),
        droppedAttributesCount: input_.dropped_attributes_count,
        flags: input_.flags,
        traceId: input_.trace_id,
...
export function jsonLogBodyToTransportDiscriminator(input_?: LogBody): any {
    ...
    if (discriminatorValue === "stringBody") {
...
export function jsonLogQueryToTransportTransform(
    ...
    return {
        query: input_.query,
        severity_min: input_.severityMin,
        service_name: input_.serviceName,
        trace_id: input_.traceId,
        span_id: input_.spanId,
        time_start: dateRfc3339Serializer(input_.timeStart),
        time_end: dateRfc3339Serializer(input_.timeEnd),
        attribute_filters: jsonArrayAttributeFilterToTransportTransform(input_.attributeFilters),
        limit: input_.limit,
        order_by: input_.orderBy
    }!;
}
...
export function jsonLogQueryToApplicationTransform(input_?: any): LogQuery {
    ...
    return {
        query: input_.query,
        severityMin: input_.severity_min,
        serviceName: input_.service_name,
        traceId: input_.trace_id,
        spanId: input_.span_id,
        timeStart: dateDeserializer(input_.time_start)!,
        timeEnd: dateDeserializer(input_.time_end)!,
        attributeFilters: jsonArrayAttributeFilterToApplicationTransform(input_.attribute_filters),
        limit: input_.limit,
        orderBy: input_.order_by
    }!;
}
...
export function jsonLogAggregationRequestToTransportTransform(
    ...
    return {
        query: jsonLogQueryToTransportTransform(input_.query),
        aggregation: jsonLogAggregationToTransportTransform(input_.aggregation)
    }!;
}
...
export function jsonLogAggregationRequestToApplicationTransform(
    ...
    return {
        query: jsonLogQueryToApplicationTransform(input_.query),
        aggregation: jsonLogAggregationToApplicationTransform(input_.aggregation)
    }!;
}
...
export function jsonLogAggregationToTransportTransform(
    ...
    return {
        group_by: jsonArrayStringToTransportTransform(input_.groupBy),
        function: input_.function_,
        field: input_.field,
        time_bucket: input_.timeBucket,
        top_n: input_.topN
    }!;
}
...
export function jsonLogAggregationToApplicationTransform(
    ...
    return {
        groupBy: jsonArrayStringToApplicationTransform(input_.group_by),
        function_: input_.function,
        field: input_.field,
        timeBucket: input_.time_bucket,
        topN: input_.top_n
    }!;
}
...
export function jsonLogPatternToTransportTransform(
    ...
    return {
        pattern_id: input_.patternId,
        template: input_.template,
        sample: input_.sample,
        count: input_.count,
        first_seen: dateRfc3339Serializer(input_.firstSeen),
        last_seen: dateRfc3339Serializer(input_.lastSeen),
        trend: input_.trend,
        severity_distribution: jsonArrayLogSeverityStatsToTransportTransform(input_.severityDistribution)
    }!;
}
...
export function jsonLogPatternToApplicationTransform(
    ...
    return {
        patternId: input_.pattern_id,
        template: input_.template,
        sample: input_.sample,
        count: input_.count,
        firstSeen: dateDeserializer(input_.first_seen)!,
        lastSeen: dateDeserializer(input_.last_seen)!,
        trend: input_.trend,
        severityDistribution: jsonArrayLogSeverityStatsToApplicationTransform(input_.severity_distribution)
    }!;
}
...
export function jsonLogStatsToTransportTransform(
    ...
    return {
        total_count: input_.totalCount,
        by_severity: jsonArrayLogCountBySeverityToTransportTransform(input_.bySeverity),
        by_service: jsonArrayLogCountByDimensionToTransportTransform(input_.byService),
        logs_per_second: input_.logsPerSecond,
        error_rate: input_.errorRate
    }!;
}
...
export function jsonLogStatsToApplicationTransform(input_?: any): LogStats {
    ...
    return {
        totalCount: input_.total_count,
        bySeverity: jsonArrayLogCountBySeverityToApplicationTransform(input_.by_severity),
        byService: jsonArrayLogCountByDimensionToApplicationTransform(input_.by_service),
        logsPerSecond: input_.logs_per_second,
        errorRate: input_.error_rate
    }!;
}
...
export function jsonCursorPageToTransportTransform_4(
    ...
    return {
        items: jsonArrayMetricMetadataToTransportTransform(input_.items),
        next_cursor: input_.nextCursor,
        prev_cursor: input_.prevCursor,
        has_more: input_.hasMore
    }!;
...
export function jsonCursorPageToApplicationTransform_4(
    ...
    return {
        items: jsonArrayMetricMetadataToApplicationTransform(input_.items),
        nextCursor: input_.next_cursor,
        prevCursor: input_.prev_cursor,
        hasMore: input_.has_more
    }!;
...
export function jsonMetricMetadataToTransportTransform(
    ...
    return {
        ...
        unit: input_.unit,
        type: input_.type,
        label_keys: jsonArrayStringToTransportTransform(input_.labelKeys),
        services: jsonArrayStringToTransportTransform(input_.services)
    }!;
}
...
export function jsonMetricMetadataToApplicationTransform(
    ...
    return {
        ...
        unit: input_.unit,
        type: input_.type,
        labelKeys: jsonArrayStringToApplicationTransform(input_.label_keys),
        services: jsonArrayStringToApplicationTransform(input_.services)
    }!;
}
...
export function jsonMetricQueryRequestToTransportTransform(
    ...
    return {
        metric_name: input_.metricName,
        filters: jsonRecordStringToTransportTransform(input_.filters),
        start_time: dateRfc3339Serializer(input_.startTime),
        end_time: dateRfc3339Serializer(input_.endTime),
        step: input_.step,
        aggregation: input_.aggregation,
        group_by: jsonArrayStringToTransportTransform(input_.groupBy)
    }!;
}
...
export function jsonMetricQueryRequestToApplicationTransform(
    ...
    return {
        metricName: input_.metric_name,
        filters: jsonRecordStringToApplicationTransform(input_.filters),
        startTime: dateDeserializer(input_.start_time)!,
        endTime: dateDeserializer(input_.end_time)!,
        step: input_.step,
        aggregation: input_.aggregation,
...
export function jsonMetricTimeSeriesToTransportTransform(
    ...
    return {
        labels: jsonRecordStringToTransportTransform(input_.labels),
        points: jsonArrayMetricDataPointToTransportTransform(input_.points)
    }!;
}
...
export function jsonMetricTimeSeriesToApplicationTransform(
    ...
    return {
        labels: jsonRecordStringToApplicationTransform(input_.labels),
        points: jsonArrayMetricDataPointToApplicationTransform(input_.points)
    }!;
}
...
export function jsonProfileRecordToTransportTransform(
    ...
    return {
        profileId: input_.profileId,
        traceId: input_.traceId,
        spanId: input_.spanId,
        sessionId: input_.sessionId,
        timeUnixNano: input_.timeUnixNano,
        durationNano: input_.durationNano,
        sampleCount: input_.sampleCount,
        sampleType: input_.sampleType,
        sampleUnit: input_.sampleUnit,
        originalPayloadFormat: input_.originalPayloadFormat,
        serviceName: input_.serviceName,
        profileFrameType: input_.profileFrameType,
        attributesJson: input_.attributesJson,
        resourceJson: input_.resourceJson,
        profileDataJson: input_.profileDataJson,
        schemaUrl: input_.schemaUrl,
        createdAt: dateRfc3339Serializer(input_.createdAt)
    }!;
}
...
export function jsonCursorPageToTransportTransform_5(
    ...
    return {
        items: jsonArraySessionEntityToTransportTransform(input_.items),
        next_cursor: input_.nextCursor,
        prev_cursor: input_.prevCursor,
        has_more: input_.hasMore
    }!;
...
export function jsonCursorPageToApplicationTransform_5(
    ...
    return {
        items: jsonArraySessionEntityToApplicationTransform(input_.items),
        nextCursor: input_.next_cursor,
        prevCursor: input_.prev_cursor,
        hasMore: input_.has_more
    }!;
...
export function jsonSessionEntityToTransportTransform(
    ...
    return {
        "session.id": input_.sessionId,
        "user.id": input_.userId,
        start_time: dateRfc3339Serializer(input_.startTime),
        end_time: dateRfc3339Serializer(input_.endTime),
        duration_ms: input_.durationMs,
        trace_count: input_.traceCount,
        span_count: input_.spanCount,
        error_count: input_.errorCount,
        services: jsonArrayStringToTransportTransform(input_.services),
        state: input_.state,
        client: jsonSessionClientInfoToTransportTransform(input_.client),
        geo: jsonSessionGeoInfoToTransportTransform(input_.geo),
        genai_usage: jsonSessionGenAiUsageToTransportTransform(input_.genaiUsage)
    }!;
}
...
export function jsonSessionEntityToApplicationTransform(
    ...
    return {
        sessionId: input_.session.id,
        userId: input_.user.id,
        startTime: dateDeserializer(input_.start_time)!,
        endTime: dateDeserializer(input_.end_time)!,
        durationMs: input_.duration_ms,
        traceCount: input_.trace_count,
        spanCount: input_.span_count,
        errorCount: input_.error_count,
        services: jsonArrayStringToApplicationTransform(input_.services),
        state: input_.state,
        client: jsonSessionClientInfoToApplicationTransform(input_.client),
        geo: jsonSessionGeoInfoToApplicationTransform(input_.geo),
        genaiUsage: jsonSessionGenAiUsageToApplicationTransform(input_.genai_usage)
    }!;
}
...
export function jsonSessionClientInfoToTransportTransform(
    ...
    return {
        ip: input_.ip,
        user_agent: input_.userAgent,
        device_type: input_.deviceType,
        os: input_.os,
        browser: input_.browser,
        browser_version: input_.browserVersion
    }!;
}
...
export function jsonSessionClientInfoToApplicationTransform(
    ...
    return {
        ip: input_.ip,
        userAgent: input_.user_agent,
        deviceType: input_.device_type,
        os: input_.os,
        browser: input_.browser,
        browserVersion: input_.browser_version
    }!;
}
...
export function jsonSessionGeoInfoToTransportTransform(
    ...
    return {
        country_code: input_.countryCode,
        country_name: input_.countryName,
        region: input_.region,
        city: input_.city,
        postal_code: input_.postalCode,
...
export function jsonSessionGeoInfoToApplicationTransform(
    ...
    return {
        countryCode: input_.country_code,
        countryName: input_.country_name,
        region: input_.region,
        city: input_.city,
        postalCode: input_.postal_code,
        timezone: input_.timezone
    }!;
}
...
export function jsonSessionGenAiUsageToTransportTransform(
    ...
    return {
        request_count: input_.requestCount,
        total_input_tokens: input_.totalInputTokens,
        total_output_tokens: input_.totalOutputTokens,
        models_used: jsonArrayStringToTransportTransform(input_.modelsUsed),
        providers_used: jsonArrayStringToTransportTransform(input_.providersUsed),
        estimated_cost_usd: input_.estimatedCostUsd
    }!;
}
...
export function jsonSessionGenAiUsageToApplicationTransform(
    ...
    return {
        requestCount: input_.request_count,
        totalInputTokens: input_.total_input_tokens,
        totalOutputTokens: input_.total_output_tokens,
        modelsUsed: jsonArrayStringToApplicationTransform(input_.models_used),
        providersUsed: jsonArrayStringToApplicationTransform(input_.providers_used),
...
export function jsonSessionStatsToTransportTransform(
    ...
    return {
        active_sessions: input_.activeSessions,
        total_sessions: input_.totalSessions,
        unique_users: input_.uniqueUsers,
        avg_duration_ms: input_.avgDurationMs,
        sessions_with_errors: input_.sessionsWithErrors,
        sessions_with_genai: input_.sessionsWithGenAi,
        bounce_rate: input_.bounceRate,
        by_device_type: jsonArraySessionDeviceStatsToTransportTransform(input_.byDeviceType),
        by_country: jsonArraySessionCountryStatsToTransportTransform(input_.byCountry)
    }!;
}
...
export function jsonSessionStatsToApplicationTransform(
    ...
    return {
        activeSessions: input_.active_sessions,
        totalSessions: input_.total_sessions,
        uniqueUsers: input_.unique_users,
        avgDurationMs: input_.avg_duration_ms,
        sessionsWithErrors: input_.sessions_with_errors,
        sessionsWithGenAi: input_.sessions_with_genai,
        bounceRate: input_.bounce_rate,
        byDeviceType: jsonArraySessionDeviceStatsToApplicationTransform(input_.by_device_type),
        byCountry: jsonArraySessionCountryStatsToApplicationTransform(input_.by_country)
    }!;
}
...
export function jsonCursorPageToTransportTransform_6(
    ...
    return {
        items: jsonArrayErrorEntityToTransportTransform(input_.items),
        next_cursor: input_.nextCursor,
        prev_cursor: input_.prevCursor,
        has_more: input_.hasMore
    }!;
...
export function jsonCursorPageToApplicationTransform_6(
    ...
    return {
        items: jsonArrayErrorEntityToApplicationTransform(input_.items),
        nextCursor: input_.next_cursor,
        prevCursor: input_.prev_cursor,
        hasMore: input_.has_more
    }!;
...
export function jsonErrorEntityToTransportTransform(
    ...
    return {
        error_id: input_.errorId,
        "error.type": input_.errorType,
        message: input_.message,
        category: input_.category,
        fingerprint: input_.fingerprint,
        first_seen: dateRfc3339Serializer(input_.firstSeen),
        last_seen: dateRfc3339Serializer(input_.lastSeen),
        occurrence_count: input_.occurrenceCount,
        affected_users: input_.affectedUsers,
        affected_services: jsonArrayStringToTransportTransform(input_.affectedServices),
        status: input_.status,
        assigned_to: input_.assignedTo,
        issue_url: input_.issueUrl,
        sample_traces: jsonArrayTraceIdToTransportTransform(input_.sampleTraces)
    }!;
}
...
export function jsonErrorEntityToApplicationTransform(
    ...
    return {
        errorId: input_.error_id,
        errorType: input_.error.type,
        message: input_.message,
        category: input_.category,
        fingerprint: input_.fingerprint,
        firstSeen: dateDeserializer(input_.first_seen)!,
        lastSeen: dateDeserializer(input_.last_seen)!,
        occurrenceCount: input_.occurrence_count,
        affectedUsers: input_.affected_users,
        affectedServices: jsonArrayStringToApplicationTransform(input_.affected_services),
        status: input_.status,
        assignedTo: input_.assigned_to,
        issueUrl: input_.issue_url,
        sampleTraces: jsonArrayTraceIdToApplicationTransform(input_.sample_traces)
    }!;
}
...
export function jsonErrorUpdateToTransportTransform(
    input_?: ErrorUpdate | null,
): any {
    if (!input_) {
        return input_ as any;
    }
...
export function jsonErrorUpdateToApplicationTransform(
    input_?: any,
): ErrorUpdate {
    if (!input_) {
        return input_ as any;
...
export function jsonErrorStatsToTransportTransform(
    ...
    return {
        total_count: input_.totalCount,
        unique_types: input_.uniqueTypes,
        error_rate: input_.errorRate,
        by_category: jsonArrayErrorCategoryStatsToTransportTransform(input_.byCategory),
        by_service: jsonArrayErrorServiceStatsToTransportTransform(input_.byService),
        top_errors: jsonArrayErrorTypeStatsToTransportTransform(input_.topErrors),
        trend: input_.trend
    }!;
}
...
export function jsonErrorStatsToApplicationTransform(
    ...
    return {
        totalCount: input_.total_count,
        uniqueTypes: input_.unique_types,
        errorRate: input_.error_rate,
        byCategory: jsonArrayErrorCategoryStatsToApplicationTransform(input_.by_category),
        byService: jsonArrayErrorServiceStatsToApplicationTransform(input_.by_service),
        topErrors: jsonArrayErrorTypeStatsToApplicationTransform(input_.top_errors),
        trend: input_.trend
    }!;
}
...
export function jsonErrorServiceStatsToTransportTransform(
    ...
    return {
        ...
        count: input_.count,
        error_rate: input_.errorRate,
        top_error_type: input_.topErrorType
    }!;
}
...
export function jsonErrorServiceStatsToApplicationTransform(
    ...
    return {
        ...
        count: input_.count,
        errorRate: input_.error_rate,
        topErrorType: input_.top_error_type
    }!;
}
...
export function jsonErrorCorrelationToTransportTransform(
    ...
    return {
        error_id: input_.errorId,
        correlated_errors: jsonArrayCorrelatedErrorToTransportTransform(input_.correlatedErrors),
        root_cause: input_.rootCause,
        common_attributes: jsonArrayAttributeToTransportTransform(input_.commonAttributes)
    }!;
}
...
export function jsonErrorCorrelationToApplicationTransform(
    ...
    return {
        errorId: input_.error_id,
        correlatedErrors: jsonArrayCorrelatedErrorToApplicationTransform(input_.correlated_errors),
        rootCause: input_.root_cause,
        commonAttributes: jsonArrayAttributeToApplicationTransform(input_.common_attributes)
    }!;
}
...
export function jsonCorrelatedErrorToTransportTransform(
    ...
    return {
        error_id: input_.errorId,
        error_type: input_.errorType,
        correlation_strength: input_.correlationStrength,
        temporal_relationship: input_.temporalRelationship
    }!;
}
...
export function jsonCorrelatedErrorToApplicationTransform(
    ...
    return {
        errorId: input_.error_id,
        errorType: input_.error_type,
        correlationStrength: input_.correlation_strength,
        temporalRelationship: input_.temporal_relationship
    }!;
}
...
export function jsonCursorPageToTransportTransform_7(
    ...
    return {
        items: jsonArrayDeploymentEntityToTransportTransform(input_.items),
        next_cursor: input_.nextCursor,
        prev_cursor: input_.prevCursor,
        has_more: input_.hasMore
    }!;
...
export function jsonCursorPageToApplicationTransform_7(
    ...
    return {
        items: jsonArrayDeploymentEntityToApplicationTransform(input_.items),
        nextCursor: input_.next_cursor,
        prevCursor: input_.prev_cursor,
        hasMore: input_.has_more
    }!;
...
export function jsonDeploymentEntityToTransportTransform(
    ...
    return {
        "deployment.id": input_.deploymentId,
        "service.name": input_.serviceName,
        "service.version": input_.serviceVersion,
        environment: input_.environment,
        status: input_.status,
        strategy: input_.strategy,
        start_time: dateRfc3339Serializer(input_.startTime),
        end_time: dateRfc3339Serializer(input_.endTime),
        duration_s: input_.durationS,
        deployed_by: input_.deployedBy,
        git_commit: input_.gitCommit,
        git_branch: input_.gitBranch,
        previous_version: input_.previousVersion,
        rollback_target: input_.rollbackTarget,
        replica_count: input_.replicaCount,
        healthy_replicas: input_.healthyReplicas,
        error_message: input_.errorMessage
    }!;
}
...
export function jsonDeploymentEntityToApplicationTransform(
    ...
    return {
        deploymentId: input_.deployment.id,
        serviceName: input_.service.name,
        serviceVersion: input_.service.version,
        environment: input_.environment,
        status: input_.status,
        ...
        startTime: dateDeserializer(input_.start_time)!,
        endTime: dateDeserializer(input_.end_time)!,
        durationS: input_.duration_s,
        deployedBy: input_.deployed_by,
        gitCommit: input_.git_commit,
        gitBranch: input_.git_branch,
        previousVersion: input_.previous_version,
        rollbackTarget: input_.rollback_target,
        replicaCount: input_.replica_count,
        healthyReplicas: input_.healthy_replicas,
        errorMessage: input_.error_message
    }!;
}

export function jsonDeploymentCreateToTransportTransform(
    input_?: DeploymentCreate | null,
): any {
    if (!input_) {
        return input_ as any;
    }
    return {
        service_name: input_.serviceName,
        service_version: input_.serviceVersion,
        environment: input_.environment,
        strategy: input_.strategy,
        deployed_by: input_.deployedBy,
        git_commit: input_.gitCommit,
...
export function jsonDeploymentCreateToApplicationTransform(
    input_?: any,
): DeploymentCreate {
    if (!input_) {
        return input_ as any;
    ...
    return {
        serviceName: input_.service_name,
        serviceVersion: input_.service_version,
        environment: input_.environment,
        strategy: input_.strategy,
        deployedBy: input_.deployed_by,
        gitCommit: input_.git_commit,
...
export function jsonDeploymentUpdateToTransportTransform(
    input_?: DeploymentUpdate | null,
): any {
    if (!input_) {
        return input_ as any;
    }
...
export function jsonDeploymentUpdateToApplicationTransform(
    input_?: any,
): DeploymentUpdate {
    if (!input_) {
        return input_ as any;
...
export function jsonDoraMetricsToTransportTransform(
    ...
    return {
        deployment_frequency: input_.deploymentFrequency,
        lead_time_hours: input_.leadTimeHours,
        change_failure_rate: input_.changeFailureRate,
        mttr_hours: input_.mttrHours,
        performance_level: input_.performanceLevel
    }!;
}
...
export function jsonDoraMetricsToApplicationTransform(
    ...
    return {
        deploymentFrequency: input_.deployment_frequency,
        leadTimeHours: input_.lead_time_hours,
        changeFailureRate: input_.change_failure_rate,
        mttrHours: input_.mttr_hours,
        performanceLevel: input_.performance_level
    }!;
}
...
export function jsonCursorPageToTransportTransform_8(
    ...
    return {
        items: jsonArrayServiceInfoToTransportTransform(input_.items),
        next_cursor: input_.nextCursor,
        prev_cursor: input_.prevCursor,
        has_more: input_.hasMore
    }!;
...
export function jsonCursorPageToApplicationTransform_8(
    ...
    return {
        items: jsonArrayServiceInfoToApplicationTransform(input_.items),
        nextCursor: input_.next_cursor,
        prevCursor: input_.prev_cursor,
        hasMore: input_.has_more
    }!;
...
export function jsonServiceInfoToTransportTransform(
    ...
    return {
        name: input_.name,
        namespace_name: input_.namespaceName,
        version: input_.version,
        instance_count: input_.instanceCount,
        last_seen: dateRfc3339Serializer(input_.lastSeen)
    }!;
}
...
export function jsonServiceInfoToApplicationTransform(
    ...
    return {
        name: input_.name,
        namespaceName: input_.namespace_name,
        version: input_.version,
        instanceCount: input_.instance_count,
        lastSeen: dateDeserializer(input_.last_seen)!
    }!;
}
...
export function jsonServiceDetailsToTransportTransform(
    ...
    return {
        ...
        instance_count: input_.instanceCount,
        last_seen: dateRfc3339Serializer(input_.lastSeen),
        resource_attributes: jsonArrayAttributeToTransportTransform(input_.resourceAttributes),
        instrumentation_libraries: jsonArrayInstrumentationScopeToTransportTransform(input_.instrumentationLibraries),
        request_rate: input_.requestRate,
        error_rate: input_.errorRate,
        avg_latency_ms: input_.avgLatencyMs,
...
export function jsonServiceDetailsToApplicationTransform(
    ...
    return {
        ...
        instanceCount: input_.instance_count,
        lastSeen: dateDeserializer(input_.last_seen)!,
        resourceAttributes: jsonArrayAttributeToApplicationTransform(input_.resource_attributes),
        instrumentationLibraries: jsonArrayInstrumentationScopeToApplicationTransform(input_.instrumentation_libraries),
        requestRate: input_.request_rate,
        errorRate: input_.error_rate,
        avgLatencyMs: input_.avg_latency_ms,
        p99LatencyMs: input_.p99_latency_ms
    }!;
}
...
export function jsonServiceDependencyToTransportTransform(
    ...
    return {
        source_service: input_.sourceService,
        target_service: input_.targetService,
        request_count: input_.requestCount,
        error_rate: input_.errorRate,
        avg_latency_ms: input_.avgLatencyMs
    }!;
...
export function jsonServiceDependencyToApplicationTransform(
    ...
    return {
        sourceService: input_.source_service,
        targetService: input_.target_service,
        requestCount: input_.request_count,
        errorRate: input_.error_rate,
        avgLatencyMs: input_.avg_latency_ms
    }!;
...
export function jsonCursorPageToTransportTransform_9(
    ...
    return {
        items: jsonArrayOperationInfoToTransportTransform(input_.items),
        next_cursor: input_.nextCursor,
        prev_cursor: input_.prevCursor,
        has_more: input_.hasMore
    }!;
...
export function jsonCursorPageToApplicationTransform_9(
    ...
    return {
        items: jsonArrayOperationInfoToApplicationTransform(input_.items),
        nextCursor: input_.next_cursor,
        prevCursor: input_.prev_cursor,
        hasMore: input_.has_more
    }!;
...
export function jsonOperationInfoToTransportTransform(
    ...
    return {
        name: input_.name,
        span_kind: input_.spanKind,
        request_count: input_.requestCount,
        error_count: input_.errorCount,
        avg_duration_ms: input_.avgDurationMs,
        p99_duration_ms: input_.p99DurationMs
    }!;
}
...
export function jsonOperationInfoToApplicationTransform(
    ...
    return {
        name: input_.name,
        spanKind: input_.span_kind,
        requestCount: input_.request_count,
        errorCount: input_.error_count,
        avgDurationMs: input_.avg_duration_ms,
        p99DurationMs: input_.p99_duration_ms
    }!;
}
...
export function jsonWorkspaceEnvelopeEntityToTransportTransform(
    ...
    return {
        id: input_.id,
        project_id: input_.projectId,
        environment_id: input_.environmentId,
        node_id: input_.nodeId,
        name: input_.name,
        root_path: input_.rootPath,
        heartbeat_at: dateRfc3339Serializer(input_.heartbeatAt),
        heartbeat_interval_seconds: input_.heartbeatIntervalSeconds,
        status: input_.status,
        config_json: input_.configJson,
        created_at: dateRfc3339Serializer(input_.createdAt),
        updated_at: dateRfc3339Serializer(input_.updatedAt)
    }!;
}
...
export function jsonWorkspaceEnvelopeEntityToApplicationTransform(
    ...
    return {
        id: input_.id,
        projectId: input_.project_id,
        environmentId: input_.environment_id,
        nodeId: input_.node_id,
        name: input_.name,
        rootPath: input_.root_path,
        heartbeatAt: dateDeserializer(input_.heartbeat_at)!,
        heartbeatIntervalSeconds: input_.heartbeat_interval_seconds,
        status: input_.status,
        configJson: input_.config_json,
        createdAt: dateDeserializer(input_.created_at)!,
        updatedAt: dateDeserializer(input_.updated_at)!
    }!;
}
...
export function jsonCursorPageToTransportTransform_10(
    ...
    return {
        items: jsonArrayProjectEntityToTransportTransform(input_.items),
        next_cursor: input_.nextCursor,
        prev_cursor: input_.prevCursor,
        has_more: input_.hasMore
    }!;
...
export function jsonCursorPageToApplicationTransform_10(
    ...
    return {
        items: jsonArrayProjectEntityToApplicationTransform(input_.items),
        nextCursor: input_.next_cursor,
        prevCursor: input_.prev_cursor,
        hasMore: input_.has_more
    }!;
...
export function jsonProjectEntityToTransportTransform(
    ...
    return {
        ...
        created_at: dateRfc3339Serializer(input_.createdAt),
        updated_at: dateRfc3339Serializer(input_.updatedAt),
        archived_at: dateRfc3339Serializer(input_.archivedAt)
    }!;
}
...
export function jsonProjectEntityToApplicationTransform(
    ...
    return {
        ...
        createdAt: dateDeserializer(input_.created_at)!,
        updatedAt: dateDeserializer(input_.updated_at)!,
        archivedAt: dateDeserializer(input_.archived_at)!
    }!;
}

export function jsonProjectCreateRequestToTransportTransform(
    input_?: ProjectCreateRequest | null,
): any {
    if (!input_) {
        return input_ as any;
    }
...
export function jsonProjectCreateRequestToApplicationTransform(
    input_?: any,
): ProjectCreateRequest {
    if (!input_) {
        return input_ as any;
...
export function jsonProjectEnvironmentEntityToTransportTransform(
    ...
    return {
        ...
        project_id: input_.projectId,
        name: input_.name,
        display_name: input_.displayName,
        color: input_.color,
        sort_order: input_.sortOrder,
        created_at: dateRfc3339Serializer(input_.createdAt)
    }!;
}
...
export function jsonProjectEnvironmentEntityToApplicationTransform(
    ...
    return {
        ...
        projectId: input_.project_id,
        name: input_.name,
        displayName: input_.display_name,
        color: input_.color,
        sortOrder: input_.sort_order,
        createdAt: dateDeserializer(input_.created_at)!
    }!;
}
...
export function jsonHandshakeSessionEntityToTransportTransform(
    ...
    return {
        id: input_.id,
        workspace_id: input_.workspaceId,
        challenge: input_.challenge,
        challenge_method: input_.challengeMethod,
        browser_fingerprint: input_.browserFingerprint,
        origin_url: input_.originUrl,
        state: input_.state,
        verified_at: dateRfc3339Serializer(input_.verifiedAt),
        expires_at: dateRfc3339Serializer(input_.expiresAt),
        created_at: dateRfc3339Serializer(input_.createdAt)
    }!;
}
...
export function jsonHandshakeSessionEntityToApplicationTransform(
    ...
    return {
        id: input_.id,
        workspaceId: input_.workspace_id,
        challenge: input_.challenge,
        challengeMethod: input_.challenge_method,
        browserFingerprint: input_.browser_fingerprint,
        originUrl: input_.origin_url,
        state: input_.state,
        verifiedAt: dateDeserializer(input_.verified_at)!,
        expiresAt: dateDeserializer(input_.expires_at)!,
        createdAt: dateDeserializer(input_.created_at)!
    }!;
}
...
export function jsonHandshakeVerifyResponseToTransportTransform(
    ...
    return {
        access_token: input_.accessToken,
        expires_at: dateRfc3339Serializer(input_.expiresAt),
        workspace_id: input_.workspaceId
    }!;
}
...
export function jsonHandshakeVerifyResponseToApplicationTransform(
    ...
    return {
        accessToken: input_.access_token,
        expiresAt: dateDeserializer(input_.expires_at)!,
        workspaceId: input_.workspace_id
    }!;
}
...
export function jsonCursorPageToTransportTransform_11(
    ...
    return {
        items: jsonArrayGenerationProfileEntityToTransportTransform(input_.items),
        next_cursor: input_.nextCursor,
        prev_cursor: input_.prevCursor,
        has_more: input_.hasMore
    }!;
...
export function jsonCursorPageToApplicationTransform_11(
    ...
    return {
        items: jsonArrayGenerationProfileEntityToApplicationTransform(input_.items),
        nextCursor: input_.next_cursor,
        prevCursor: input_.prev_cursor,
        hasMore: input_.has_more
    }!;
...
export function jsonGenerationProfileEntityToTransportTransform(
    ...
    return {
        ...
        name: input_.name,
        description: input_.description,
        target_framework: input_.targetFramework,
        target_language: input_.targetLanguage,
        semconv_version: input_.semconvVersion,
        features_json: input_.featuresJson,
        template_overrides_json: input_.templateOverridesJson,
        is_default: input_.isDefault,
        created_at: dateRfc3339Serializer(input_.createdAt),
        updated_at: dateRfc3339Serializer(input_.updatedAt)
    }!;
}
...
export function jsonGenerationProfileEntityToApplicationTransform(
    ...
    return {
        ...
        name: input_.name,
        description: input_.description,
        targetFramework: input_.target_framework,
        targetLanguage: input_.target_language,
        semconvVersion: input_.semconv_version,
        featuresJson: input_.features_json,
        templateOverridesJson: input_.template_overrides_json,
        isDefault: input_.is_default,
        createdAt: dateDeserializer(input_.created_at)!,
        updatedAt: dateDeserializer(input_.updated_at)!
    }!;
}

export function jsonGenerationProfileCreateRequestToTransportTransform(
    input_?: GenerationProfileCreateRequest | null,
): any {
    if (!input_) {
        return input_ as any;
    }
...
export function jsonGenerationProfileCreateRequestToApplicationTransform(
    input_?: any,
): GenerationProfileCreateRequest {
    if (!input_) {
        return input_ as any;
...
export function jsonGenerationSelectionEntityToTransportTransform(
    ...
    return {
        id: input_.id,
        workspace_id: input_.workspaceId,
        profile_id: input_.profileId,
        selection_type: input_.selectionType,
        selection_key: input_.selectionKey,
...
export function jsonGenerationSelectionEntityToApplicationTransform(
    ...
    return {
        id: input_.id,
        workspaceId: input_.workspace_id,
        profileId: input_.profile_id,
        selectionType: input_.selection_type,
        selectionKey: input_.selection_key,
        enabled: input_.enabled,
        configJson: input_.config_json,
        createdAt: dateDeserializer(input_.created_at)!,
        updatedAt: dateDeserializer(input_.updated_at)!
...
export function jsonGenerationJobCreateRequestToTransportTransform(
    input_?: GenerationJobCreateRequest | null,
): any {
    if (!input_) {
        return input_ as any;
    }
...
export function jsonGenerationJobCreateRequestToApplicationTransform(
    input_?: any,
): GenerationJobCreateRequest {
    if (!input_) {
        return input_ as any;
...
export function jsonGenerationJobEntityToTransportTransform(
    ...
    return {
        ...
        workspace_id: input_.workspaceId,
        profile_id: input_.profileId,
        job_type: input_.jobType,
        status: input_.status,
        priority: input_.priority,
        input_hash: input_.inputHash,
        output_path: input_.outputPath,
        output_hash: input_.outputHash,
        error_message: input_.errorMessage,
        queued_at: dateRfc3339Serializer(input_.queuedAt),
        started_at: dateRfc3339Serializer(input_.startedAt),
        completed_at: dateRfc3339Serializer(input_.completedAt),
        duration_ms: input_.durationMs
    }!;
}
...
export function jsonGenerationJobEntityToApplicationTransform(
    ...
    return {
        ...
        workspaceId: input_.workspace_id,
        profileId: input_.profile_id,
        jobType: input_.job_type,
        status: input_.status,
        priority: input_.priority,
        inputHash: input_.input_hash,
        outputPath: input_.output_path,
        outputHash: input_.output_hash,
        errorMessage: input_.error_message,
        queuedAt: dateDeserializer(input_.queued_at)!,
        startedAt: dateDeserializer(input_.started_at)!,
        completedAt: dateDeserializer(input_.completed_at)!,
        durationMs: input_.duration_ms
    }!;
}
...
export function jsonCursorPageToTransportTransform_12(
    ...
    return {
        items: jsonArrayErrorIssueEntityToTransportTransform(input_.items),
        next_cursor: input_.nextCursor,
        prev_cursor: input_.prevCursor,
        has_more: input_.hasMore
    }!;
...
export function jsonCursorPageToApplicationTransform_12(
    ...
    return {
        items: jsonArrayErrorIssueEntityToApplicationTransform(input_.items),
        nextCursor: input_.next_cursor,
        prevCursor: input_.prev_cursor,
        hasMore: input_.has_more
    }!;
...
export function jsonErrorIssueEntityToTransportTransform(
    ...
    return {
        ...
        fingerprint: input_.fingerprint,
        title: input_.title,
        culprit: input_.culprit,
        error_type: input_.errorType,
        category: input_.category,
        level: input_.level,
        platform: input_.platform,
        first_seen_at: dateRfc3339Serializer(input_.firstSeenAt),
        last_seen_at: dateRfc3339Serializer(input_.lastSeenAt),
        occurrence_count: input_.occurrenceCount,
        affected_users_count: input_.affectedUsersCount,
        status: input_.status,
        substatus: input_.substatus,
        priority: input_.priority,
        assigned_to: input_.assignedTo,
        resolved_at: dateRfc3339Serializer(input_.resolvedAt),
        resolved_by: input_.resolvedBy,
        regression_count: input_.regressionCount,
        last_release: input_.lastRelease,
        tags_json: input_.tagsJson,
        metadata_json: input_.metadataJson,
        created_at: dateRfc3339Serializer(input_.createdAt),
        updated_at: dateRfc3339Serializer(input_.updatedAt)
    }!;
}
...
export function jsonErrorIssueEntityToApplicationTransform(
    ...
    return {
        ...
        level: input_.level,
        platform: input_.platform,
        firstSeenAt: dateDeserializer(input_.first_seen_at)!,
        lastSeenAt: dateDeserializer(input_.last_seen_at)!,
        occurrenceCount: input_.occurrence_count,
        ...
        priority: input_.priority,
        assignedTo: input_.assigned_to,
        resolvedAt: dateDeserializer(input_.resolved_at)!,
        resolvedBy: input_.resolved_by,
        regressionCount: input_.regression_count,
        lastRelease: input_.last_release,
        tagsJson: input_.tags_json,
        metadataJson: input_.metadata_json,
        createdAt: dateDeserializer(input_.created_at)!,
        updatedAt: dateDeserializer(input_.updated_at)!
    }!;
}

export function jsonIssueUpdateRequestToTransportTransform(
    input_?: IssueUpdateRequest | null,
): any {
    if (!input_) {
        return input_ as any;
    }
...
export function jsonIssueUpdateRequestToApplicationTransform(
    input_?: any,
): IssueUpdateRequest {
    if (!input_) {
        return input_ as any;
...
export function jsonCursorPageToTransportTransform_13(
    ...
    return {
        items: jsonArrayErrorIssueEventEntityToTransportTransform(input_.items),
        next_cursor: input_.nextCursor,
        prev_cursor: input_.prevCursor,
        has_more: input_.hasMore
    }!;
...
export function jsonCursorPageToApplicationTransform_13(
    ...
    return {
        items: jsonArrayErrorIssueEventEntityToApplicationTransform(input_.items),
        nextCursor: input_.next_cursor,
        prevCursor: input_.prev_cursor,
        hasMore: input_.has_more
    }!;
...
export function jsonErrorIssueEventEntityToTransportTransform(
    ...
    return {
        id: input_.id,
        issue_id: input_.issueId,
        trace_id: input_.traceId,
        span_id: input_.spanId,
        message: input_.message,
        stack_trace: input_.stackTrace,
        stack_frames_json: input_.stackFramesJson,
        environment: input_.environment,
        release_version: input_.releaseVersion,
        user_id: input_.userId,
        user_ip: input_.userIp,
        request_url: input_.requestUrl,
        request_method: input_.requestMethod,
        browser: input_.browser,
        os: input_.os,
        device: input_.device,
        runtime: input_.runtime,
        runtime_version: input_.runtimeVersion,
        context_json: input_.contextJson,
        tags_json: input_.tagsJson,
        timestamp: dateRfc3339Serializer(input_.timestamp)
    }!;
}
...
export function jsonErrorIssueEventEntityToApplicationTransform(
    ...
    return {
        id: input_.id,
        issueId: input_.issue_id,
        traceId: input_.trace_id,
        spanId: input_.span_id,
        message: input_.message,
        stackTrace: input_.stack_trace,
        stackFramesJson: input_.stack_frames_json,
        environment: input_.environment,
        releaseVersion: input_.release_version,
        userId: input_.user_id,
        userIp: input_.user_ip,
        requestUrl: input_.request_url,
        requestMethod: input_.request_method,
        browser: input_.browser,
        os: input_.os,
        device: input_.device,
        runtime: input_.runtime,
        runtimeVersion: input_.runtime_version,
        contextJson: input_.context_json,
        tagsJson: input_.tags_json,
        timestamp: dateDeserializer(input_.timestamp)!
    }!;
}
...
export function jsonErrorBreadcrumbEntityToTransportTransform(
    ...
    return {
        ...
        breadcrumb_type: input_.breadcrumbType,
        category: input_.category,
        message: input_.message,
        level: input_.level,
        data_json: input_.dataJson,
        timestamp: dateRfc3339Serializer(input_.timestamp)
    }!;
}
...
export function jsonErrorBreadcrumbEntityToApplicationTransform(
    ...
    return {
        id: input_.id,
        eventId: input_.event_id,
        breadcrumbType: input_.breadcrumb_type,
        category: input_.category,
        message: input_.message,
        level: input_.level,
        dataJson: input_.data_json,
        timestamp: dateDeserializer(input_.timestamp)!
    }!;
}
...
export function jsonCursorPageToTransportTransform_14(
    ...
    return {
        items: jsonArrayWorkflowRunEntityToTransportTransform(input_.items),
        next_cursor: input_.nextCursor,
        prev_cursor: input_.prevCursor,
        has_more: input_.hasMore
    }!;
...
export function jsonCursorPageToApplicationTransform_14(
    ...
    return {
        items: jsonArrayWorkflowRunEntityToApplicationTransform(input_.items),
        nextCursor: input_.next_cursor,
        prevCursor: input_.prev_cursor,
        hasMore: input_.has_more
    }!;
...
export function jsonWorkflowRunEntityToTransportTransform(
    ...
    return {
        id: input_.id,
        workflow_id: input_.workflowId,
        workflow_version: input_.workflowVersion,
        project_id: input_.projectId,
        trigger_type: input_.triggerType,
        trigger_source: input_.triggerSource,
        input_json: input_.inputJson,
        output_json: input_.outputJson,
        status: input_.status,
        error_message: input_.errorMessage,
        parent_run_id: input_.parentRunId,
        correlation_id: input_.correlationId,
        started_at: dateRfc3339Serializer(input_.startedAt),
        completed_at: dateRfc3339Serializer(input_.completedAt),
        duration_ms: input_.durationMs,
        created_at: dateRfc3339Serializer(input_.createdAt)
...
export function jsonWorkflowRunEntityToApplicationTransform(
    ...
    return {
        id: input_.id,
        workflowId: input_.workflow_id,
        workflowVersion: input_.workflow_version,
        projectId: input_.project_id,
        triggerType: input_.trigger_type,
        triggerSource: input_.trigger_source,
        inputJson: input_.input_json,
        outputJson: input_.output_json,
        status: input_.status,
        errorMessage: input_.error_message,
        parentRunId: input_.parent_run_id,
        correlationId: input_.correlation_id,
        startedAt: dateDeserializer(input_.started_at)!,
        completedAt: dateDeserializer(input_.completed_at)!,
        durationMs: input_.duration_ms,
        createdAt: dateDeserializer(input_.created_at)!
...
export function jsonCursorPageToTransportTransform_15(
    ...
    return {
        items: jsonArrayWorkflowNodeEntityToTransportTransform(input_.items),
        next_cursor: input_.nextCursor,
        prev_cursor: input_.prevCursor,
        has_more: input_.hasMore
    }!;
...
export function jsonCursorPageToApplicationTransform_15(
    ...
    return {
        items: jsonArrayWorkflowNodeEntityToApplicationTransform(input_.items),
        nextCursor: input_.next_cursor,
        prevCursor: input_.prev_cursor,
        hasMore: input_.has_more
    }!;
...
export function jsonWorkflowNodeEntityToTransportTransform(
    ...
    return {
        ...
        run_id: input_.runId,
        node_id: input_.nodeId,
        node_type: input_.nodeType,
        node_name: input_.nodeName,
        attempt: input_.attempt,
        input_json: input_.inputJson,
        output_json: input_.outputJson,
        status: input_.status,
        error_message: input_.errorMessage,
        retry_count: input_.retryCount,
        max_retries: input_.maxRetries,
        timeout_ms: input_.timeoutMs,
        started_at: dateRfc3339Serializer(input_.startedAt),
        completed_at: dateRfc3339Serializer(input_.completedAt),
        duration_ms: input_.durationMs,
        created_at: dateRfc3339Serializer(input_.createdAt)
...
export function jsonWorkflowNodeEntityToApplicationTransform(
    ...
    return {
        ...
        runId: input_.run_id,
        nodeId: input_.node_id,
        nodeType: input_.node_type,
        nodeName: input_.node_name,
        attempt: input_.attempt,
        inputJson: input_.input_json,
        outputJson: input_.output_json,
        status: input_.status,
        errorMessage: input_.error_message,
        retryCount: input_.retry_count,
        maxRetries: input_.max_retries,
        timeoutMs: input_.timeout_ms,
        startedAt: dateDeserializer(input_.started_at)!,
        completedAt: dateDeserializer(input_.completed_at)!,
        durationMs: input_.duration_ms,
        createdAt: dateDeserializer(input_.created_at)!
...
export function jsonWorkflowEventEntityToTransportTransform(
    ...
    return {
        ...
        run_id: input_.runId,
        node_id: input_.nodeId,
        event_type: input_.eventType,
        event_name: input_.eventName,
        payload_json: input_.payloadJson,
        sequence_number: input_.sequenceNumber,
...
export function jsonWorkflowEventEntityToApplicationTransform(
    ...
    return {
        ...
        runId: input_.run_id,
        nodeId: input_.node_id,
        eventType: input_.event_type,
        eventName: input_.event_name,
        payloadJson: input_.payload_json,
        sequenceNumber: input_.sequence_number,
        source: input_.source,
        correlationId: input_.correlation_id,
        timestamp: dateDeserializer(input_.timestamp)!
    }!;
...
export function jsonSearchRequestToTransportTransform(
    ...
    return {
        query: input_.query,
        entity_types: jsonArraySearchEntityTypeToTransportTransform(input_.entityTypes),
        project_id: input_.projectId,
        limit: input_.limit,
        cursor: input_.cursor
    }!;
...
export function jsonSearchRequestToApplicationTransform(
    ...
    return {
        query: input_.query,
        entityTypes: jsonArraySearchEntityTypeToApplicationTransform(input_.entity_types),
        projectId: input_.project_id,
        limit: input_.limit,
        cursor: input_.cursor
    }!;
...
export function jsonSearchResponseToTransportTransform(
    ...
    return {
        results: jsonArraySearchResultToTransportTransform(input_.results),
        total_count: input_.totalCount,
        duration_ms: input_.durationMs,
        next_cursor: input_.nextCursor,
        suggestions: jsonArrayStringToTransportTransform(input_.suggestions)
    }!;
}
...
export function jsonSearchResponseToApplicationTransform(
    ...
    return {
        results: jsonArraySearchResultToApplicationTransform(input_.results),
        totalCount: input_.total_count,
        durationMs: input_.duration_ms,
        nextCursor: input_.next_cursor,
        suggestions: jsonArrayStringToApplicationTransform(input_.suggestions)
    }!;
}
...
export function jsonSearchResultToTransportTransform(
    ...
    return {
        document_id: input_.documentId,
        entity_type: input_.entityType,
        entity_id: input_.entityId,
        title: input_.title,
        snippet: input_.snippet,
        score: input_.score,
        url: input_.url
    }!;
}
...
export function jsonSearchResultToApplicationTransform(
    ...
    return {
        documentId: input_.document_id,
        entityType: input_.entity_type,
        entityId: input_.entity_id,
        title: input_.title,
        snippet: input_.snippet,
        score: input_.score,
        url: input_.url
...
export function jsonCursorPageToTransportTransform_16(
    ...
    return {
        items: jsonArrayAlertRuleEntityToTransportTransform(input_.items),
        next_cursor: input_.nextCursor,
        prev_cursor: input_.prevCursor,
        has_more: input_.hasMore
    }!;
...
export function jsonCursorPageToApplicationTransform_16(
    ...
    return {
        items: jsonArrayAlertRuleEntityToApplicationTransform(input_.items),
        nextCursor: input_.next_cursor,
        prevCursor: input_.prev_cursor,
        hasMore: input_.has_more
    }!;
...
export function jsonAlertRuleEntityToTransportTransform(
    ...
    return {
        ...
        name: input_.name,
        description: input_.description,
        rule_type: input_.ruleType,
        condition_json: input_.conditionJson,
        threshold_json: input_.thresholdJson,
        target_type: input_.targetType,
        target_filter_json: input_.targetFilterJson,
        severity: input_.severity,
        cooldown_seconds: input_.cooldownSeconds,
        notification_channels_json: input_.notificationChannelsJson,
        enabled: input_.enabled,
        last_triggered_at: dateRfc3339Serializer(input_.lastTriggeredAt),
        trigger_count: input_.triggerCount,
        created_at: dateRfc3339Serializer(input_.createdAt),
        updated_at: dateRfc3339Serializer(input_.updatedAt)
    }!;
}
...
export function jsonAlertRuleEntityToApplicationTransform(
    ...
    return {
        ...
        name: input_.name,
        description: input_.description,
        ruleType: input_.rule_type,
        conditionJson: input_.condition_json,
        thresholdJson: input_.threshold_json,
        targetType: input_.target_type,
        targetFilterJson: input_.target_filter_json,
        severity: input_.severity,
        cooldownSeconds: input_.cooldown_seconds,
        notificationChannelsJson: input_.notification_channels_json,
        enabled: input_.enabled,
        lastTriggeredAt: dateDeserializer(input_.last_triggered_at)!,
        triggerCount: input_.trigger_count,
        createdAt: dateDeserializer(input_.created_at)!,
        updatedAt: dateDeserializer(input_.updated_at)!
    }!;
}
...
export function jsonCursorPageToTransportTransform_17(
    ...
    return {
        items: jsonArrayAlertFiringEntityToTransportTransform(input_.items),
        next_cursor: input_.nextCursor,
        prev_cursor: input_.prevCursor,
        has_more: input_.hasMore
    }!;
...
export function jsonCursorPageToApplicationTransform_17(
    ...
    return {
        items: jsonArrayAlertFiringEntityToApplicationTransform(input_.items),
        nextCursor: input_.next_cursor,
        prevCursor: input_.prev_cursor,
        hasMore: input_.has_more
    }!;
...
export function jsonAlertFiringEntityToTransportTransform(
    ...
    return {
        id: input_.id,
        rule_id: input_.ruleId,
        fingerprint: input_.fingerprint,
        severity: input_.severity,
        title: input_.title,
        message: input_.message,
        trigger_value: input_.triggerValue,
        threshold_value: input_.thresholdValue,
        context_json: input_.contextJson,
        status: input_.status,
        acknowledged_at: dateRfc3339Serializer(input_.acknowledgedAt),
        acknowledged_by: input_.acknowledgedBy,
        resolved_at: dateRfc3339Serializer(input_.resolvedAt),
        fired_at: dateRfc3339Serializer(input_.firedAt),
        dedup_key: input_.dedupKey
    }!;
}
...
export function jsonAlertFiringEntityToApplicationTransform(
    ...
    return {
        id: input_.id,
        ruleId: input_.rule_id,
        fingerprint: input_.fingerprint,
        severity: input_.severity,
        title: input_.title,
        message: input_.message,
        triggerValue: input_.trigger_value,
        thresholdValue: input_.threshold_value,
        contextJson: input_.context_json,
        status: input_.status,
        acknowledgedAt: dateDeserializer(input_.acknowledged_at)!,
        acknowledgedBy: input_.acknowledged_by,
        resolvedAt: dateDeserializer(input_.resolved_at)!,
        firedAt: dateDeserializer(input_.fired_at)!,
        dedupKey: input_.dedup_key
    }!;
}
...
export function jsonCursorPageToTransportTransform_18(
    ...
    return {
        items: jsonArrayFixRunEntityToTransportTransform(input_.items),
        next_cursor: input_.nextCursor,
        prev_cursor: input_.prevCursor,
        has_more: input_.hasMore
    }!;
...
export function jsonCursorPageToApplicationTransform_18(
    ...
    return {
        items: jsonArrayFixRunEntityToApplicationTransform(input_.items),
        nextCursor: input_.next_cursor,
        prevCursor: input_.prev_cursor,
        hasMore: input_.has_more
    }!;
...
export function jsonFixRunEntityToTransportTransform(
    ...
    return {
        id: input_.id,
        issue_id: input_.issueId,
        alert_firing_id: input_.alertFiringId,
        trigger_type: input_.triggerType,
        strategy: input_.strategy,
        model_name: input_.modelName,
        model_provider: input_.modelProvider,
        status: input_.status,
        error_message: input_.errorMessage,
        tokens_used: input_.tokensUsed,
        duration_ms: input_.durationMs,
        created_at: dateRfc3339Serializer(input_.createdAt),
        started_at: dateRfc3339Serializer(input_.startedAt),
        completed_at: dateRfc3339Serializer(input_.completedAt)
...
export function jsonFixRunEntityToApplicationTransform(
    ...
    return {
        id: input_.id,
        issueId: input_.issue_id,
        alertFiringId: input_.alert_firing_id,
        triggerType: input_.trigger_type,
        strategy: input_.strategy,
        modelName: input_.model_name,
        modelProvider: input_.model_provider,
        status: input_.status,
        errorMessage: input_.error_message,
        tokensUsed: input_.tokens_used,
        durationMs: input_.duration_ms,
        createdAt: dateDeserializer(input_.created_at)!,
        startedAt: dateDeserializer(input_.started_at)!,
        completedAt: dateDeserializer(input_.completed_at)!
