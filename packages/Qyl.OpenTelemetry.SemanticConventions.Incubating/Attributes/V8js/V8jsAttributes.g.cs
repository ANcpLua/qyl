...
public static class V8jsAttributes
{
    ...
    /// <summary>The type of resource keeping the event loop active..</summary>
    public const string ResourceType = "v8js.resource.type";

    /// <summary>Values for the <c>ResourceType</c> attribute.</summary>
    public static class ResourceTypeValues
    {
        /// <summary>Active `setImmediate` callbacks..</summary>
        public const string Immediate = "Immediate";
        /// <summary>Active TCP Servers..</summary>
        public const string Tcpserverwrap = "TCPServerWrap";
        /// <summary>Active TCP connections..</summary>
        public const string Tcpwrap = "TCPWrap";
        /// <summary>Active `setTimeout` or `setInterval` timers..</summary>
        public const string Timeout = "Timeout";
        /// <summary>Active Terminal I/O (stdin/stdout)..</summary>
