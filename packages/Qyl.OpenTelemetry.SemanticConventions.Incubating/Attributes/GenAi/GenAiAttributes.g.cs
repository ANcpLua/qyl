...
public static class GenAiAttributes
{
    ...
    public static class ProviderNameValues
    {
        ...
        /// <summary>[Azure OpenAI](https://azure.microsoft.com/products/ai-services/openai-service/).</summary>
    ...
    /// <summary>The list of source system tool definitions available to the GenAI agent or model..</summary>
    /// <remarks>The value of this attribute matches source system tool definition format.  It's expected to be an array of objects where each object represents a tool definition. In case a serialized string is available to the instrumentation, the instrumentation SHOULD do the best effort to deserialize it to an array. When recorded on spans, it MAY be recorded as a JSON string if structured format is not supported and SHOULD be recorded in structured form otherwise.  Since this attribute could be large, it's NOT RECOMMENDED to populate it by default. Instrumentations MAY provide a way to enable populating this attribute.</remarks>
