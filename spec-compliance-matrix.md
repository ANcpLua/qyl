...
| Feature | Optional | JS | Python | .NET |
| ------- | -------- | -- | ------ | ---- |
| [TracerProvider](specification/trace/api.md#tracerprovider-operations) | Optional | JS | Python | .NET |
...
| [Trace / Context interaction](specification/trace/api.md#context-interaction) | Optional | JS | Python | .NET |
| Get active Span |  | + | + | + |
| Set active Span |  | + | + | + |
| [Tracer](specification/trace/api.md#tracer-operations) | Optional | JS | Python | .NET |
| Create a new Span |  | + | + | + |
| Documentation defines adding attributes at span creation as preferred |  |  | + | + |
| Get active Span |  | + | + | + |
| Mark Span active |  | + | + | + |
| Safe for concurrent calls |  | + | + | + |
| [SpanContext](specification/trace/api.md#spancontext) | Optional | JS | Python | .NET |
| IsValid |  | + | + | + |
| IsRemote |  | + | + | + |
| Conforms to the W3C TraceContext spec |  | + | + | + |
| [Support W3C Trace Context Level 2 randomness](specification/trace/sdk.md#traceid-randomness) |  |  |  |  |
| [Span](specification/trace/api.md#span) | Optional | JS | Python | .NET |
| Create root span |  | + | + | + |
...
| [Span attributes](specification/trace/api.md#set-attributes) | Optional | JS | Python | .NET |
| SetAttribute |  | + | + | + |
...
| [Span linking](specification/trace/api.md#specifying-links) | Optional | JS | Python | .NET |
| Links can be recorded on span creation |  | + | + | + |
| Links can be recorded after span creation |  | + | + | + |
| Links order is preserved |  | + | + | + |
| [Span events](specification/trace/api.md#add-events) | Optional | JS | Python | .NET |
| AddEvent |  | + | + | + |
| Add order preserved |  | + | + | + |
| Safe for concurrent calls |  | + | + | + |
| [Span exceptions](specification/trace/api.md#record-exception) | Optional | JS | Python | .NET |
| RecordException |  | + | + | + |
| RecordException with extra parameters |  | + | + | + |
| [Sampling](specification/trace/sdk.md#sampling) | Optional | JS | Python | .NET |
...
| **[OTLP](specification/protocol/otlp.md)** | Optional | JS | Python | .NET |
| OTLP/gRPC Exporter | * | + | + | + |
...
| **[Zipkin](specification/trace/sdk_exporters/zipkin.md)** | Optional | JS | Python | .NET |
| Zipkin V1 JSON | X |  | + | - |
...
| **Prometheus** | Optional | JS | Python | .NET |
