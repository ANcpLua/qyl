...
// `@encodedName("application/json", Qyl.OTel.Keys.<Domain>.<Ident>)` in qyl
// TypeSpec source files.
//
// The mapping comes from core/specs/generated/otel-keys.gen.tsp, which is
// regenerated by ./eng/semconv/run-weaver.sh from the pinned upstream OTel
// registry. Hand-edit of either file is forbidden — re-run weaver instead.
//
