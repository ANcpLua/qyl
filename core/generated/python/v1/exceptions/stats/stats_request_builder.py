...
if TYPE_CHECKING:
    ...
    from ....models.qyl.domains.observe.exceptions.exception_stats import ExceptionStats
...
class StatsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1/exceptions/stats{?endTime,serviceName,startTime}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[StatsRequestBuilderGetQueryParameters]] = None) -> Optional[ExceptionStats]:
        """
        Get exception statistics
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[ExceptionStats]
        """
        ...
        return await self.request_adapter.send_async(request_info, ExceptionStats, error_mapping)
