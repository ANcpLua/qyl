...
if TYPE_CHECKING:
    ...
    from ...models.qyl.domains.ops.cicd.cicd_pipeline_status import CicdPipelineStatus
    from ...models.qyl.domains.ops.cicd.cicd_system import CicdSystem
    from .pipelines_get_response import PipelinesGetResponse
...
class PipelinesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1/pipelines{?cursor,endTime,limit,pipelineName,startTime,status,system}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[PipelinesRequestBuilderGetQueryParameters]] = None) -> Optional[PipelinesGetResponse]:
        """
        List pipeline runs
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[PipelinesGetResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, PipelinesGetResponse, error_mapping)
    ...
    class PipelinesRequestBuilderGetQueryParameters():
        ...
        def get_query_parameter(self,original_name: str) -> str:
            ...
            if original_name == "end_time":
                return "endTime"
            if original_name == "pipeline_name":
                return "pipelineName"
