...
if TYPE_CHECKING:
    from ....models.pipeline_stats import PipelineStats
...
class StatsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1/pipelines/stats{?endTime,pipelineName,startTime}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[StatsRequestBuilderGetQueryParameters]] = None) -> Optional[PipelineStats]:
        """
        Get pipeline statistics
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[PipelineStats]
        """
        ...
        return await self.request_adapter.send_async(request_info, PipelineStats, error_mapping)
