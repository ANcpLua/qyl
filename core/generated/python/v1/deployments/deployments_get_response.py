...
@dataclass
class DeploymentsGetResponse(AdditionalDataHolder, Parsable):
    """
    ...
    items: Optional[list[DeploymentEntity]] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeploymentsGetResponse:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "items": lambda n : setattr(self, 'items', n.get_collection_of_object_values(DeploymentEntity)),
