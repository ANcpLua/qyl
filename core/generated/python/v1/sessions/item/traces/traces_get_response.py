...
if TYPE_CHECKING:
    from .....models.qyl.o_tel.traces.trace import Trace

@dataclass
class TracesGetResponse(AdditionalDataHolder, Parsable):
    """
    ...
    items: Optional[list[Trace]] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TracesGetResponse:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "items": lambda n : setattr(self, 'items', n.get_collection_of_object_values(Trace)),
