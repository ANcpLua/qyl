...
if TYPE_CHECKING:
    from ...models.qyl.domains.observe.session.session_entity import SessionEntity

@dataclass
class SessionsGetResponse(AdditionalDataHolder, Parsable):
    """
    ...
    items: Optional[list[SessionEntity]] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> SessionsGetResponse:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "items": lambda n : setattr(self, 'items', n.get_collection_of_object_values(SessionEntity)),
