...
if TYPE_CHECKING:
    ...
    from ....models.qyl.domains.observe.session.session_stats import SessionStats
...
class StatsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1/sessions/stats{?endTime,startTime}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[StatsRequestBuilderGetQueryParameters]] = None) -> Optional[SessionStats]:
        """
        Get session statistics
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[SessionStats]
        """
        ...
        return await self.request_adapter.send_async(request_info, SessionStats, error_mapping)
