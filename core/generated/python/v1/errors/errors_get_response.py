...
@dataclass
class ErrorsGetResponse(AdditionalDataHolder, Parsable):
    """
    ...
    items: Optional[list[ErrorEntity]] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ErrorsGetResponse:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "items": lambda n : setattr(self, 'items', n.get_collection_of_object_values(ErrorEntity)),
