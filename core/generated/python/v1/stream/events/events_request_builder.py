...
if TYPE_CHECKING:
    from ....models.streaming.stream_event_type import StreamEventType
...
class EventsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1/stream/events{?sampleRate,serviceName,types}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[EventsRequestBuilderGetQueryParameters]] = None) -> Optional[bytes]:
        """
    ...
    class EventsRequestBuilderGetQueryParameters():
        ...
        # Event types
        types: list[StreamEventType] = field(default_factory=list)
