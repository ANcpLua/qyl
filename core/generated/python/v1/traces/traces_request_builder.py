...
if TYPE_CHECKING:
    ...
    from .traces_get_response import TracesGetResponse
...
class TracesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1/traces{?cursor,endTime,limit,maxDurationMs,minDurationMs,serviceName,startTime,status}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[TracesRequestBuilderGetQueryParameters]] = None) -> Optional[TracesGetResponse]:
        """
        List traces with pagination
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[TracesGetResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, TracesGetResponse, error_mapping)
    ...
    class TracesRequestBuilderGetQueryParameters():
        ...
        def get_query_parameter(self,original_name: str) -> str:
            ...
            if original_name == "end_time":
                return "endTime"
            if original_name == "max_duration_ms":
