...
if TYPE_CHECKING:
    ...
    from .operations_get_response import OperationsGetResponse
...
class OperationsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1/services/{serviceName}/operations{?cursor,limit}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[OperationsRequestBuilderGetQueryParameters]] = None) -> Optional[OperationsGetResponse]:
        """
        Get service operations
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[OperationsGetResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, OperationsGetResponse, error_mapping)
