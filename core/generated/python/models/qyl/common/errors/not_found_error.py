...
@dataclass
class NotFoundError(APIError, AdditionalDataHolder, Parsable):
    """
    ...
    # The title property
    title: Optional[NotFoundError_title] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> NotFoundError:
        """
