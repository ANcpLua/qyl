...
@dataclass
class LogAggregationBucket(AdditionalDataHolder, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> LogAggregationBucket:
        """
