...
export function deserializeIntoEnrichedException(enrichedException: Partial<EnrichedException> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "affected_users": n => { enrichedException.affectedUsers = n.getNumberValue(); },
        "cause": n => { enrichedException.cause = n.getObjectValue<EnrichedException>(createEnrichedExceptionFromDiscriminatorValue); },
        "data": n => { enrichedException.data = n.getCollectionOfObjectValues<Attribute>(createAttributeFromDiscriminatorValue); },
        "exception_type": n => { enrichedException.exceptionType = n.getStringValue(); },
        "fingerprint": n => { enrichedException.fingerprint = n.getStringValue(); },
        "first_seen": n => { enrichedException.firstSeen = n.getDateValue(); },
        "last_seen": n => { enrichedException.lastSeen = n.getDateValue(); },
        "message": n => { enrichedException.message = n.getStringValue(); },
        "occurrence_count": n => { enrichedException.occurrenceCount = n.getNumberValue(); },
        "stack_trace": n => { enrichedException.stackTrace = n.getObjectValue<StackTrace>(createStackTraceFromDiscriminatorValue); },
        "status": n => { enrichedException.status = n.getEnumValue<ExceptionStatus>(ExceptionStatusObject); },
    }
}
/**
 * The deserialization information for the current model
...
export function deserializeIntoExceptionServiceStats(exceptionServiceStats: Partial<ExceptionServiceStats> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "count": n => { exceptionServiceStats.count = n.getNumberValue(); },
        "rate_per_minute": n => { exceptionServiceStats.ratePerMinute = n.getNumberValue(); },
        "service_name": n => { exceptionServiceStats.serviceName = n.getStringValue(); },
    }
}
/**
 * The deserialization information for the current model
...
export function deserializeIntoExceptionStats(exceptionStats: Partial<ExceptionStats> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "by_service": n => { exceptionStats.byService = n.getCollectionOfObjectValues<ExceptionServiceStats>(createExceptionServiceStatsFromDiscriminatorValue); },
        "by_type": n => { exceptionStats.byType = n.getCollectionOfObjectValues<ExceptionTypeStats>(createExceptionTypeStatsFromDiscriminatorValue); },
        "total_count": n => { exceptionStats.totalCount = n.getNumberValue(); },
        "trend": n => { exceptionStats.trend = n.getEnumValue<ExceptionTrend>(ExceptionTrendObject); },
        "unique_types": n => { exceptionStats.uniqueTypes = n.getNumberValue(); },
    }
}
/**
 * The deserialization information for the current model
...
export function deserializeIntoExceptionTypeStats(exceptionTypeStats: Partial<ExceptionTypeStats> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "count": n => { exceptionTypeStats.count = n.getNumberValue(); },
        "exception_type": n => { exceptionTypeStats.exceptionType = n.getStringValue(); },
        "percentage": n => { exceptionTypeStats.percentage = n.getNumberValue(); },
        "status": n => { exceptionTypeStats.status = n.getEnumValue<ExceptionStatus>(ExceptionStatusObject); },
    }
}
/**
...
export function serializeEnrichedException(writer: SerializationWriter, enrichedException: Partial<EnrichedException> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!enrichedException || isSerializingDerivedType) { return; }
...
export function serializeExceptionServiceStats(writer: SerializationWriter, exceptionServiceStats: Partial<ExceptionServiceStats> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!exceptionServiceStats || isSerializingDerivedType) { return; }
...
export function serializeExceptionStats(writer: SerializationWriter, exceptionStats: Partial<ExceptionStats> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!exceptionStats || isSerializingDerivedType) { return; }
...
export function serializeExceptionTypeStats(writer: SerializationWriter, exceptionTypeStats: Partial<ExceptionTypeStats> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!exceptionTypeStats || isSerializingDerivedType) { return; }
