...
// @ts-ignore
import { createAttributeFromDiscriminatorValue, createInstrumentationScopeFromDiscriminatorValue, serializeAttribute, serializeInstrumentationScope, type Attribute, type InstrumentationScope } from '../../common/index.js';
// @ts-ignore
import { createResourceFromDiscriminatorValue, serializeResource, type Resource } from '../resource/index.js';
// @ts-ignore
...
export function deserializeIntoSpan(span: Partial<Span> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "attributes": n => { span.attributes = n.getCollectionOfObjectValues<Attribute>(createAttributeFromDiscriminatorValue); },
        "dropped_attributes_count": n => { span.droppedAttributesCount = n.getNumberValue(); },
        "dropped_events_count": n => { span.droppedEventsCount = n.getNumberValue(); },
        "dropped_links_count": n => { span.droppedLinksCount = n.getNumberValue(); },
        "end_time_unix_nano": n => { span.endTimeUnixNano = n.getNumberValue(); },
        "events": n => { span.events = n.getCollectionOfObjectValues<SpanEvent>(createSpanEventFromDiscriminatorValue); },
        "flags": n => { span.flags = n.getNumberValue(); },
        "instrumentation_scope": n => { span.instrumentationScope = n.getObjectValue<InstrumentationScope>(createInstrumentationScopeFromDiscriminatorValue); },
        "kind": n => { span.kind = n.getNumberValue(); },
        "links": n => { span.links = n.getCollectionOfObjectValues<SpanLink>(createSpanLinkFromDiscriminatorValue); },
        "name": n => { span.name = n.getStringValue(); },
        "parent_span_id": n => { span.parentSpanId = n.getStringValue(); },
        "resource": n => { span.resource = n.getObjectValue<Resource>(createResourceFromDiscriminatorValue); },
        "span_id": n => { span.spanId = n.getStringValue(); },
        "start_time_unix_nano": n => { span.startTimeUnixNano = n.getNumberValue(); },
        "status": n => { span.status = n.getObjectValue<SpanStatus>(createSpanStatusFromDiscriminatorValue); },
        "trace_id": n => { span.traceId = n.getStringValue(); },
        "trace_state": n => { span.traceState = n.getStringValue(); },
    }
}
/**
 * The deserialization information for the current model
...
export function deserializeIntoSpanEvent(spanEvent: Partial<SpanEvent> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "attributes": n => { spanEvent.attributes = n.getCollectionOfObjectValues<Attribute>(createAttributeFromDiscriminatorValue); },
        "dropped_attributes_count": n => { spanEvent.droppedAttributesCount = n.getNumberValue(); },
        "name": n => { spanEvent.name = n.getStringValue(); },
        "time_unix_nano": n => { spanEvent.timeUnixNano = n.getNumberValue(); },
    }
}
/**
 * The deserialization information for the current model
...
export function deserializeIntoSpanLink(spanLink: Partial<SpanLink> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "attributes": n => { spanLink.attributes = n.getCollectionOfObjectValues<Attribute>(createAttributeFromDiscriminatorValue); },
        "dropped_attributes_count": n => { spanLink.droppedAttributesCount = n.getNumberValue(); },
        "flags": n => { spanLink.flags = n.getNumberValue(); },
        "span_id": n => { spanLink.spanId = n.getStringValue(); },
        "trace_id": n => { spanLink.traceId = n.getStringValue(); },
        "trace_state": n => { spanLink.traceState = n.getStringValue(); },
    }
}
/**
 * The deserialization information for the current model
...
export function deserializeIntoSpanStatus(spanStatus: Partial<SpanStatus> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "code": n => { spanStatus.code = n.getNumberValue(); },
        "message": n => { spanStatus.message = n.getStringValue(); },
    }
}
/**
 * The deserialization information for the current model
...
export function deserializeIntoTrace(trace: Partial<Trace> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "duration_ns": n => { trace.durationNs = n.getNumberValue(); },
        "end_time": n => { trace.endTime = n.getDateValue(); },
        "has_error": n => { trace.hasError = n.getBooleanValue(); },
        "root_span": n => { trace.rootSpan = n.getObjectValue<Span>(createSpanFromDiscriminatorValue); },
        "services": n => { trace.services = n.getCollectionOfPrimitiveValues<string>(); },
        "span_count": n => { trace.spanCount = n.getNumberValue(); },
        "spans": n => { trace.spans = n.getCollectionOfObjectValues<Span>(createSpanFromDiscriminatorValue); },
        "start_time": n => { trace.startTime = n.getDateValue(); },
        "trace_id": n => { trace.traceId = n.getStringValue(); },
    }
}
/**
...
export function serializeSpan(writer: SerializationWriter, span: Partial<Span> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!span || isSerializingDerivedType) { return; }
...
export function serializeSpanEvent(writer: SerializationWriter, spanEvent: Partial<SpanEvent> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!spanEvent || isSerializingDerivedType) { return; }
...
export function serializeSpanLink(writer: SerializationWriter, spanLink: Partial<SpanLink> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!spanLink || isSerializingDerivedType) { return; }
...
export function serializeSpanStatus(writer: SerializationWriter, spanStatus: Partial<SpanStatus> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!spanStatus || isSerializingDerivedType) { return; }
...
export function serializeTrace(writer: SerializationWriter, trace: Partial<Trace> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!trace || isSerializingDerivedType) { return; }
