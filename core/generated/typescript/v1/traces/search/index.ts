...
export function deserializeIntoSearchPostResponse(searchPostResponse: Partial<SearchPostResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "has_more": n => { searchPostResponse.hasMore = n.getBooleanValue(); },
        "items": n => { searchPostResponse.items = n.getCollectionOfObjectValues<Trace>(createTraceFromDiscriminatorValue); },
        "next_cursor": n => { searchPostResponse.nextCursor = n.getStringValue(); },
        "prev_cursor": n => { searchPostResponse.prevCursor = n.getStringValue(); },
    }
}
/**
