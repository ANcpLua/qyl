...
// @ts-ignore
import { serializeDeploymentCreate, type DeploymentCreate } from '../../models/index.js';
// @ts-ignore
...
// @ts-ignore
import { createDeploymentEntityFromDiscriminatorValue, DeploymentEnvironment, DeploymentStatus, serializeDeploymentEntity, type DeploymentEntity } from '../../models/qyl/domains/ops/deployment/index.js';
// @ts-ignore
...
export function deserializeIntoDeploymentsGetResponse(deploymentsGetResponse: Partial<DeploymentsGetResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "has_more": n => { deploymentsGetResponse.hasMore = n.getBooleanValue(); },
        "items": n => { deploymentsGetResponse.items = n.getCollectionOfObjectValues<DeploymentEntity>(createDeploymentEntityFromDiscriminatorValue); },
        "next_cursor": n => { deploymentsGetResponse.nextCursor = n.getStringValue(); },
        "prev_cursor": n => { deploymentsGetResponse.prevCursor = n.getStringValue(); },
    }
}
/**
