...
// @ts-ignore
import { HealthRequestBuilderNavigationMetadata, HealthRequestBuilderRequestsMetadata, type HealthRequestBuilder } from './health/index.js';
// @ts-ignore
...
/**
 * Instantiates a new {@link QylClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createQylClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<QylClient>(requestAdapter, pathParameters, QylClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface QylClient extends BaseRequestBuilder<QylClient> {
    /**
     * The health property
     */
 ...
 */
export const QylClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const QylClientNavigationMetadata: Record<Exclude<keyof QylClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    health: {
