...
**Architecture:** Monolith split — extract shared tools into `qyl.mcp.core`, add `qyl.mcp.sentry` for Sentry API, add `qyl.mcp.cloud` for Azure Container App with HTTP transport + OAuth. See `docs/plans/2026-03-01-qyl-mcp-platform-design.md`.
...
**Design Doc:** `docs/plans/2026-03-01-qyl-mcp-platform-design.md`
