...
- [ADR-003: .NET Premium SDK](adrs/ADR-003-nuget-first-instrumentation.md) — how `gen_ai.*` interceptors are emitted by source generators
- [Architecture docs](architecture/) — pipeline from OTLP ingest to DuckDB storage
