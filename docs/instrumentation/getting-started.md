...
out the [automatic instrumentation guide](https://opentelemetry.io/docs/zero-code/dotnet/getting-started/).
...
you can use OpenTelemetry .NET with other frameworks as well.
