...
the SDK also ships with a self-diagnostics feature, which helps with troubleshooting.
...
> **Tip**: In most cases, you can drop the file alongside your application. On Windows,
> you can use
