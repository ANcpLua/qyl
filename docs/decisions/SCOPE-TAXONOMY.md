...
|----------------------|---------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|
| ` IMPLEMENTED-IN-QYL.LOOM` | Capability exists in this repository and is runnable/testable locally.                            | Code path + endpoint mapping + storage/UI/tool references in `src/**`. |
...
4. If a feature moves from context to implementation, relabel to ` IMPLEMENTED-IN-QYL.LOOM`
