...
| **Use explicit scope labels in design docs** | Avoid generic "out-of-scope" buckets. Use `IMPLEMENTED-IN-QYL`, `CONTEXT-ONLY`, `EXTERNAL-CLOSED`, and `NOT-PLANNED` to keep roadmap/spec docs precise. |
