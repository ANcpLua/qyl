...
/// </summary>
/// <remarks>
///     Serialised with camelCase field names (matching the <c>loom-sdk-onboarding</c>
///     skill and prompt contracts) via per-property <see cref="JsonPropertyNameAttribute" />
///     annotations. The attributes are authoritative even when the serializer does not
///     pick up <see cref="LoomWorkflowToolsJsonContext" />.
/// </remarks>
public sealed record DotnetProjectEvidence
{
    ...
    [JsonPropertyName("recommendedInitFile")]
    ...
    [JsonPropertyName("loggingLibraries")]
    ...
    [JsonPropertyName("schedulerLibraries")]
    ...
    [JsonPropertyName("siblingFrontendDirs")]
    ...
    [JsonPropertyName("requiresGlobalMode")]
...
public sealed record DotnetFeatureRecommendations
{
    ...
    [JsonPropertyName("errorMonitoring")]
