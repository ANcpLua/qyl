...
public static class Pattern01_SwitchRouting
{
    ...
    public static async Task RunAsync(IQylLoomPatternsAgentsBuilder agents, CancellationToken ct)
    {
        ...
        var criticalSink  = new SeverityHandler("patterns/01/critical", severity: "critical");
        var warningSink   = new SeverityHandler("patterns/01/warning",  severity: "warning");
        var fallbackSink  = new SeverityHandler("patterns/01/fallback", severity: "fallback");
