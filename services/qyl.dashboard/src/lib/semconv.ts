...
export const K8S_NODE_SYSTEM_CONTAINER_NAME = "k8s.node.system_container.name";

// k8s.node
export const K8S_NODE_UID = "k8s.node.uid";

// k8s.persistentvolume
export const K8S_PERSISTENTVOLUME_ANNOTATION = "k8s.persistentvolume.annotation";
export const K8S_PERSISTENTVOLUME_LABEL = "k8s.persistentvolume.label";
export const K8S_PERSISTENTVOLUME_NAME = "k8s.persistentvolume.name";
export const K8S_PERSISTENTVOLUME_RECLAIM_POLICY = "k8s.persistentvolume.reclaim_policy";

// k8s.persistentvolume.status
export const K8S_PERSISTENTVOLUME_STATUS_PHASE = "k8s.persistentvolume.status.phase";

// k8s.persistentvolume
export const K8S_PERSISTENTVOLUME_UID = "k8s.persistentvolume.uid";

// k8s.persistentvolumeclaim
export const K8S_PERSISTENTVOLUMECLAIM_ANNOTATION = "k8s.persistentvolumeclaim.annotation";
export const K8S_PERSISTENTVOLUMECLAIM_LABEL = "k8s.persistentvolumeclaim.label";
export const K8S_PERSISTENTVOLUMECLAIM_NAME = "k8s.persistentvolumeclaim.name";

// k8s.persistentvolumeclaim.status
export const K8S_PERSISTENTVOLUMECLAIM_STATUS_PHASE = "k8s.persistentvolumeclaim.status.phase";

// k8s.persistentvolumeclaim
export const K8S_PERSISTENTVOLUMECLAIM_UID = "k8s.persistentvolumeclaim.uid";
...
// system.memory.linux.hugepages
export const SYSTEM_MEMORY_LINUX_HUGEPAGES_STATE = "system.memory.linux.hugepages.state";
