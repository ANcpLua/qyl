        ...
        [EnumeratorCancellation] CancellationToken ct = default)
    {
        ...
        if (rootCause is not null)
        {
            yield return MakeContent(
                JsonSerializer.Serialize(rootCause, LoomExplorerJsonContext.Default.LoomRootCause),
                "root_cause");
        }
        ...
        {
            yield return MakeContent(
                JsonSerializer.Serialize(solution, LoomExplorerJsonContext.Default.LoomSolution),
                "solution");
        }
