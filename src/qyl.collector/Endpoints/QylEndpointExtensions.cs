...
public static class QylEndpointExtensions
{
        ...
        [StringSyntax("Route")] string pattern = "/api/v1/sessions")
    {
        ...
        group.MapGet("/{sessionId}/spans", async (
            string sessionId,
            DuckDbStore store,
            CancellationToken ct) => await SpanEndpoints.GetSessionSpansAsync(sessionId, store, ct)
                .ConfigureAwait(false))
        ...
        [StringSyntax("Route")] string pattern = "/api/v1/traces")
    {
        ...
        group.MapGet("/{traceId}", async (string traceId, DuckDbStore store) =>
    ...
    public static IEndpointRouteBuilder MapIngestionEndpoints(this IEndpointRouteBuilder endpoints)
    {
        ...
        endpoints.MapPost("/api/v1/ingest", async (
            HttpContext context,
            DuckDbStore store,
