...
/// <summary>
///     DuckDB storage row for OTel Profiles (v1development).
///     Normalized design: promoted query columns on header, child data in separate tables.
/// </summary>
/// <remarks>
///     Generator creates: AddParameters, MapFromReader, BuildMultiRowInsertSql.
///     Property order must match SELECT column order for MapFromReader.
...
/// <summary>Full profile with all normalized child data — returned by detail endpoint.</summary>
...
/// <summary>Conversion result from OtlpConverter — profile header + child rows for insertion.</summary>
