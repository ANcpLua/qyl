...
ALTER TABLE logs ADD COLUMN IF NOT EXISTS log_id VARCHAR;
ALTER TABLE logs ADD COLUMN IF NOT EXISTS session_id VARCHAR;
ALTER TABLE logs ADD COLUMN IF NOT EXISTS service_name VARCHAR;
ALTER TABLE logs ADD COLUMN IF NOT EXISTS attributes_json VARCHAR;
ALTER TABLE logs ADD COLUMN IF NOT EXISTS resource_json VARCHAR;

ALTER TABLE logs ALTER COLUMN observed_time_unix_nano DROP NOT NULL;
ALTER TABLE logs ALTER COLUMN resource DROP NOT NULL;
