...
/// <summary>
///     OTel MCP (Model Context Protocol) semantic convention attribute keys.
///     Status: Development
///     https://opentelemetry.io/docs/specs/semconv/mcp/
/// </summary>
public static class McpAttributes
{
    ...
    /// <summary>ActivitySource name for MCP instrumentation.</summary>
    public const string SourceName = "OpenTelemetry.Instrumentation.MCP";

    // ═══════════════════════════════════════════════════════════════════════
    // Core MCP attributes
    // ═══════════════════════════════════════════════════════════════════════

    /// <summary>mcp.method.name - The name of the request or notification method.</summary>
    public const string MethodName = "mcp.method.name";

    /// <summary>mcp.protocol.version - The version of the Model Context Protocol used.</summary>
    public const string ProtocolVersion = "mcp.protocol.version";

    /// <summary>mcp.session.id - Identifies MCP session.</summary>
    public const string SessionId = "mcp.session.id";

    /// <summary>mcp.resource.uri - The value of the resource uri.</summary>
    ...
    /// <summary>jsonrpc.request.id - A string representation of the id property of the request.</summary>
    public const string JsonRpcRequestId = "jsonrpc.request.id";

    /// <summary>jsonrpc.protocol.version - Protocol version, as specified in the jsonrpc property.</summary>
    public const string JsonRpcProtocolVersion = "jsonrpc.protocol.version";

    /// <summary>rpc.response.status_code - The error code from the JSON-RPC response.</summary>
    public const string RpcResponseStatusCode = "rpc.response.status_code";

    // ═══════════════════════════════════════════════════════════════════════
    // Network attributes (standard OTel)
    // ═══════════════════════════════════════════════════════════════════════

    /// <summary>network.protocol.name - OSI application layer or non-OSI equivalent.</summary>
    public const string NetworkProtocolName = "network.protocol.name";

    /// <summary>network.protocol.version - The actual version of the protocol used for network communication.</summary>
    public const string NetworkProtocolVersion = "network.protocol.version";

    /// <summary>network.transport - The transport protocol used for the MCP session.</summary>
    public const string NetworkTransport = "network.transport";

    // ═══════════════════════════════════════════════════════════════════════
    // MCP method name values (mcp.method.name)
    // ═══════════════════════════════════════════════════════════════════════
    ...
    {
        // Requests
        /// <summary>initialize - Request to initialize the MCP client.</summary>
        public const string Initialize = "initialize";

        /// <summary>ping - Request to check that the other party is still alive.</summary>
        public const string Ping = "ping";

        /// <summary>completion/complete - Request to complete a prompt.</summary>
        public const string CompletionComplete = "completion/complete";

        /// <summary>elicitation/create - Request from the server to elicit additional information.</summary>
        public const string ElicitationCreate = "elicitation/create";

        /// <summary>logging/setLevel - Request to set the logging level.</summary>
        public const string LoggingSetLevel = "logging/setLevel";

        /// <summary>prompts/get - Request to get a prompt.</summary>
        public const string PromptsGet = "prompts/get";

        /// <summary>prompts/list - Request to list prompts available on server.</summary>
        public const string PromptsList = "prompts/list";

        /// <summary>resources/list - Request to list resources available on server.</summary>
        public const string ResourcesList = "resources/list";

        /// <summary>resources/read - Request to read a resource.</summary>
        public const string ResourcesRead = "resources/read";

        /// <summary>resources/subscribe - Request to subscribe to a resource.</summary>
        public const string ResourcesSubscribe = "resources/subscribe";

        /// <summary>resources/templates/list - Request to list resource templates available on server.</summary>
        public const string ResourcesTemplatesList = "resources/templates/list";

        /// <summary>resources/unsubscribe - Request to unsubscribe from resource updates.</summary>
        public const string ResourcesUnsubscribe = "resources/unsubscribe";

        /// <summary>roots/list - Request to list roots available on server.</summary>
        public const string RootsList = "roots/list";

        /// <summary>sampling/createMessage - Request to create a sampling message.</summary>
        public const string SamplingCreateMessage = "sampling/createMessage";

        /// <summary>tools/call - Request to call a tool.</summary>
        public const string ToolsCall = "tools/call";

        /// <summary>tools/list - Request to list tools available on server.</summary>
        public const string ToolsList = "tools/list";

        // Notifications
        /// <summary>notifications/cancelled - Notification cancelling a previously-issued request.</summary>
        public const string NotificationsCancelled = "notifications/cancelled";

        /// <summary>notifications/initialized - Notification indicating that the MCP client has been initialized.</summary>
        public const string NotificationsInitialized = "notifications/initialized";

        /// <summary>notifications/message - Notification indicating that a message has been received.</summary>
        public const string NotificationsMessage = "notifications/message";

        /// <summary>notifications/progress - Notification indicating the progress for a long-running operation.</summary>
        public const string NotificationsProgress = "notifications/progress";

        /// <summary>notifications/prompts/list_changed - Notification indicating that the list of prompts has changed.</summary>
        public const string NotificationsPromptsListChanged = "notifications/prompts/list_changed";

        /// <summary>notifications/resources/list_changed - Notification indicating that the list of resources has changed.</summary>
        public const string NotificationsResourcesListChanged = "notifications/resources/list_changed";

        /// <summary>notifications/resources/updated - Notification indicating that a resource has been updated.</summary>
        public const string NotificationsResourcesUpdated = "notifications/resources/updated";

        /// <summary>notifications/roots/list_changed - Notification indicating that the list of roots has changed.</summary>
        public const string NotificationsRootsListChanged = "notifications/roots/list_changed";

        /// <summary>notifications/tools/list_changed - Notification indicating that the list of tools has changed.</summary>
        public const string NotificationsToolsListChanged = "notifications/tools/list_changed";
    }

    // ═══════════════════════════════════════════════════════════════════════
    // Network transport values (network.transport)
    // ═══════════════════════════════════════════════════════════════════════

    /// <summary>Well-known network transport values.</summary>
    public static class Transports
    {
        /// <summary>pipe - Named or anonymous pipe (stdio).</summary>
        public const string Pipe = "pipe";

        /// <summary>quic - QUIC.</summary>
        public const string Quic = "quic";

        /// <summary>tcp - TCP.</summary>
        public const string Tcp = "tcp";

        /// <summary>udp - UDP.</summary>
        public const string Udp = "udp";

        /// <summary>unix - Unix domain socket.</summary>
    ...
    /// <summary>MCP metrics names.</summary>
    public static class Metrics
    {
        /// <summary>mcp.client.operation.duration - The duration of the MCP request or notification on the sender.</summary>
        public const string ClientOperationDuration = "mcp.client.operation.duration";

        /// <summary>mcp.server.operation.duration - MCP request or notification duration on the receiver.</summary>
        public const string ServerOperationDuration = "mcp.server.operation.duration";

        /// <summary>mcp.client.session.duration - The duration of the MCP session on the client.</summary>
        public const string ClientSessionDuration = "mcp.client.session.duration";

        /// <summary>mcp.server.session.duration - The duration of the MCP session on the server.</summary>
        public const string ServerSessionDuration = "mcp.server.session.duration";
    }
}
