...
{
    private const string TracedFull = "Qyl.Instrumentation.Instrumentation.TracedAttribute";
    private const string TracedTagFull = "Qyl.Instrumentation.Instrumentation.TracedTagAttribute";
    private const string NoTraceFull = "Qyl.Instrumentation.Instrumentation.NoTraceAttribute";
