...
namespace Qyl.Agents.Instrumentation;
...
/// </summary>
[Meter("Qyl.Agents", Version = "1.0.0")]
public static partial class CopilotMetrics
{
    ...
    [Histogram("Qyl.Agents.workflow.duration", Unit = "s",
    ...
    [Counter("Qyl.Agents.workflow.executions", Unit = "{execution}",
