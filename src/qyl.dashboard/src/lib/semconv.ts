...
export const K8sServiceEndpointAddressTypeValues = {
  Fqdn: "FQDN",
  Ipv4: "IPv4",
  Ipv6: "IPv6",
} as const;

export const K8sServiceEndpointConditionValues = {
  Ready: "ready",
  Serving: "serving",
  Terminating: "terminating",
} as const;

export const K8sServiceTypeValues = {
  ClusterIp: "ClusterIP",
...
export const OpenaiApiTypeValues = {
...
export const ServiceCriticalityValues = {
  Critical: "critical",
  High: "high",
  Low: "low",
  Medium: "medium",
