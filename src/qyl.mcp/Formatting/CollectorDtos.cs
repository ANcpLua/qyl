...
internal sealed record TraceSummaryDto(
    ...
    [property: JsonPropertyName("root_span")] string RootSpan,
...
internal sealed record SpanDetailDto(
    ...
    [property: JsonPropertyName("span_name")] string SpanName,
...
internal sealed record ServiceInfoDto(
    [property: JsonPropertyName("name")] string Name,
    [property: JsonPropertyName("instance_count")] int InstanceCount,
...
internal sealed record ProjectInfoDto(
    ...
    [property: JsonPropertyName("name")] string Name,
    [property: JsonPropertyName("description")] string? Description = null,
    [property: JsonPropertyName("retention_days")] int? RetentionDays = null);
