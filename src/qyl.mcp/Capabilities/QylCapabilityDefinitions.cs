...
[QylCapabilityDefinition("server_introspection",
    ...
    Summary = "Discover qyl.mcp capabilities, enabled skill families, and the smallest useful tool chain before starting an investigation.",
    SkillLabel = "core",
...
[QylCapabilityDefinition("trace_investigation", QylSkillKind.Inspect,
    ...
    Summary = "Search traces, inspect span trees, correlate latency and failure boundaries, and escalate to RCA only after evidence is captured.",
...
[QylCapabilityDefinition("error_investigation", QylSkillKind.Inspect,
    ...
    Summary = "Move from issue-level symptoms into event details, breadcrumbs, attachments, and timelines before mutating triage state.",
...
[QylCapabilityDefinition("log_investigation", QylSkillKind.Inspect,
    ...
    Summary = "Search logs directly or pivot from a trace to its structured logs to confirm request-level evidence and runtime context.",
...
[QylCapabilityDefinition("session_investigation", QylSkillKind.Inspect,
    ...
    Summary = "Investigate end-user or agent sessions, replay transcripts, and correlated traces to reconstruct multi-step behavior.",
...
[QylCapabilityDefinition("service_discovery", QylSkillKind.Inspect,
    ...
    Summary = "List projects and services, inspect service topology, and tie health regressions back to release boundaries.",
...
[QylCapabilityDefinition("metrics_analysis", QylSkillKind.Inspect,
    ...
    Summary = "Enumerate metrics, query timeseries, and baseline operational behavior before escalating to anomaly or regression workflows.",
...
[QylCapabilityDefinition("genai_observability", QylSkillKind.Inspect,
    ...
    Summary = "Track provider, model, token, cost, and latency behavior for agent and LLM workloads, then pivot into traces or sessions when needed.",
...
[QylCapabilityDefinition("health_and_storage", QylSkillKind.Health,
    ...
    Summary = "Check overall collector/system health and storage posture before concluding an investigation is product-specific.",
...
[QylCapabilityDefinition("analytics", QylSkillKind.Analytics,
    ...
    Summary = "Inspect conversations, coverage gaps, source analytics, satisfaction, and user journeys to evaluate product behavior over time.",
...
[QylCapabilityDefinition("agentic_investigation", QylSkillKind.Agent,
    ...
    Summary = "Use qyl's embedded investigation and summarization tools for multi-step reasoning after narrower evidence-oriented tools have established context.",
...
[QylCapabilityDefinition("project_and_access_management", QylSkillKind.Build,
    ...
    Summary = "Manage projects, retention, API keys, teams, and DSNs from the MCP server when operational workflows need bounded write actions.",
...
[QylCapabilityDefinition("anomaly_detection", QylSkillKind.Anomaly,
    ...
    Summary = "Detect unusual behavior, compare periods, and establish metric baselines before escalating to regression or RCA workflows.",
...
[QylCapabilityDefinition("loom_triage_and_fix", QylSkillKind.Loom,
    ...
    Summary = "Drive qyl's AI-assisted triage, autofix, regression, code review, and handoff workflows once issue evidence is stable enough for action.",
...
[QylCapabilityDefinition("mcp_apps", QylSkillKind.Apps,
    ...
    Summary = "Open qyl's interactive app surfaces for traces, errors, and query workflows when a visual or operator-facing experience is better than raw tool chaining.",
...
[QylCapabilityDefinition("debugger_control", QylSkillKind.Debug,
    ...
    Summary = "Proxy into the Rider debugger MCP surface to inspect program state, set breakpoints, and walk execution when telemetry evidence points to live-code debugging.",
