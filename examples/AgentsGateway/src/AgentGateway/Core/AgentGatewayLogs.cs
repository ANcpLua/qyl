...
{
    [LoggerMessage(Level = LogLevel.Error, Message = "Missing configuration section '{TokenValidationSectionName}'. This section is required to be present in appsettings.json")]
