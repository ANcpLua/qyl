...
public class QylGenAiNonCanonicalAttributeAnalyzerTests
{
    ...
    private static CSharpAnalyzerTest<QylGenAiNonCanonicalAttributeAnalyzer, DefaultVerifier> CreateTest(string testCode)
    {
    ...
    public async Task NonCanonicalGenAiAttribute_ReportsDiagnostic()
    {
        ...
        test.ExpectedDiagnostics.Add(
            new DiagnosticResult(QylGenAiNonCanonicalAttributeAnalyzer.DiagnosticId, Microsoft.CodeAnalysis.DiagnosticSeverity.Warning)
                .WithLocation(8, 9)
    ...
    {
        // Deprecated attributes are handled by QYL001, not QYL002
        const string text = """
            using System.Diagnostics;
