...
//     /// </summary>
//     /// <remarks>This constructor initializes logging using an <see cref="redirectSystemConsoleOutput"/> and sets up
//     /// configuration from multiple sources, including a JSON file, environment variables, and user secrets.
//     /// If <paramref name="redirectSystemConsoleOutput"/> is <see langword="true"/>, calls to <see cref="System"/>
//     /// will be redirected to the test output provided by <paramref name="output"/>.
//     /// </remarks>
//     /// <param name="output">The <see cref="redirectSystemConsoleOutput"/> instance used to write test output.</param>
//     /// <param name="redirectSystemConsoleOutput">
//     /// A value indicating whether <see cref="System"/> output should be redirected to the test output. <see langword="true"/> to redirect; otherwise, <see langword="false"/>.
//     /// </param>
...
//         WriteMessageOutput(new ChatMessage(ChatRole.User, message));
//
//     /// <summary>
...
//         void WriteUsage()
//         {
//             if (!(printUsage ?? true) || response.Usage is null)
//             {
//                 return;
//             }
//
...
//
//             Console.WriteLine(
//                 $"  [Usage] Tokens: {usageDetails.TotalTokenCount}, Input: {usageDetails.InputTokenCount}, Output: {usageDetails.OutputTokenCount}");
//         }
//     }
//
//     /// <summary>
...
//         const bool
//             IsCode = false; //message.AdditionalProperties?.ContainsKey(OpenAIAssistantAgent.CodeInterpreterMetadataKey) ?? false;
...
//             {
//                 Console.WriteLine(
//                     $"  [{item.GetType().Name}] {image.Uri?.ToString() ?? image.Uri ?? $"{image.Data.Length} bytes"}");
//             }
...
//             {
//                 Console.WriteLine(
//                     $"  [{item.GetType().Name}] {functionResult.CallId} - {AsJson(functionResult.Result) ?? "*"}");
//             }
//         }
//
